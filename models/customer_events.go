...
func (q customerEventQuery) All(ctx context.Context, exec boil.ContextExecutor) (CustomerEventSlice, error) {
	var o []*CustomerEvent
...
func (q customerEventQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	var count int64
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count customer_events rows")
	}
...
func (q customerEventQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	var count int64
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if customer_events exists")
	}
...
func FindCustomerEvent(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*CustomerEvent, error) {
	...
	err := q.Bind(ctx, exec, customerEventObj)
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) {
			return nil, sql.ErrNoRows
		}
...
func (o *CustomerEvent) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no customer_events provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into customer_events")
	}
...
func (o *CustomerEvent) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update customer_events row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for customer_events")
	}
...
func (q customerEventQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	queries.SetUpdate(q.Query, cols)

	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for customer_events")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for customer_events")
	}
...
func (o CustomerEventSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in customerEvent slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all customerEvent")
	}
	return rowsAff, nil
}
...
func (o *CustomerEvent) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert customer_events, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"customer_events\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert customer_events")
	}
...
func (o *CustomerEvent) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from customer_events")
	}
...
func (q customerEventQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no customerEventQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from customer_events")
	}
...
func (o CustomerEventSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from customerEvent slice")
	}
...
func (o *CustomerEvent) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindCustomerEvent(ctx, exec, o.ID)
	if err != nil {
		return err
	}
...
func (o *CustomerEventSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in CustomerEventSlice")
	}
...
func CustomerEventExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if customer_events exists")
	}
...
func (o *CustomerEvent) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return CustomerEventExists(ctx, exec, o.ID)
}
