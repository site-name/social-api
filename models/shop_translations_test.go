...
var (
	shopTranslationDBTypes = map[string]string{`ID`: `uuid`, `LanguageCode`: `character varying`, `Name`: `character varying`, `Description`: `character varying`, `CreatedAt`: `bigint`, `UpdatedAt`: `bigint`}
	_                      = bytes.MinRead
)
