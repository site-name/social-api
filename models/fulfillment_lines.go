...
func (q fulfillmentLineQuery) All(ctx context.Context, exec boil.ContextExecutor) (FulfillmentLineSlice, error) {
...
func (q fulfillmentLineQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	var count int64
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count fulfillment_lines rows")
	}
...
func (q fulfillmentLineQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	var count int64
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if fulfillment_lines exists")
	}
...
func FindFulfillmentLine(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*FulfillmentLine, error) {
	...
	err := q.Bind(ctx, exec, fulfillmentLineObj)
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) {
			return nil, sql.ErrNoRows
		}
...
func (o *FulfillmentLine) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no fulfillment_lines provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into fulfillment_lines")
	}
...
func (o *FulfillmentLine) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update fulfillment_lines row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for fulfillment_lines")
	}
...
func (q fulfillmentLineQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	queries.SetUpdate(q.Query, cols)

	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for fulfillment_lines")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for fulfillment_lines")
	}
...
func (o FulfillmentLineSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in fulfillmentLine slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all fulfillmentLine")
	}
	return rowsAff, nil
}
...
func (o *FulfillmentLine) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert fulfillment_lines, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"fulfillment_lines\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert fulfillment_lines")
	}
...
func (o *FulfillmentLine) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from fulfillment_lines")
	}
...
func (q fulfillmentLineQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no fulfillmentLineQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from fulfillment_lines")
	}
...
func (o FulfillmentLineSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from fulfillmentLine slice")
	}
...
func (o *FulfillmentLine) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindFulfillmentLine(ctx, exec, o.ID)
	if err != nil {
		return err
	}
...
func (o *FulfillmentLineSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in FulfillmentLineSlice")
	}
...
func FulfillmentLineExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if fulfillment_lines exists")
	}
...
func (o *FulfillmentLine) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return FulfillmentLineExists(ctx, exec, o.ID)
}
