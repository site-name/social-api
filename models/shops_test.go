...
var (
	shopDBTypes = map[string]string{`ID`: `uuid`, `CreatedAt`: `bigint`, `UpdatedAt`: `bigint`, `Name`: `character varying`, `Description`: `character varying`, `TopMenuID`: `uuid`, `IncludeTaxesInPrice`: `boolean`, `DisplayGrossPrices`: `boolean`, `ChargeTaxesOnShipping`: `boolean`, `TrackInventoryByDefault`: `boolean`, `DefaultWeightUnit`: `character varying`, `AutomaticFulfillmentDigitalProducts`: `boolean`, `DefaultDigitalMaxDownloads`: `integer`, `DefaultDigitalURLValidDays`: `integer`, `AddressID`: `uuid`, `DefaultMailSenderName`: `character varying`, `DefaultMailSenderAddress`: `text`, `CustomerSetPasswordURL`: `text`, `AutomaticallyConfirmAllNewOrders`: `boolean`, `FulfillmentAutoApprove`: `boolean`, `FulfillmentAllowUnpaid`: `boolean`, `GiftCardExpiryType`: `character varying`, `GiftCardExpiryPeriodType`: `character varying`, `GiftCardExpiryPeriod`: `integer`, `AutomaticallyFulfillNonShippableGiftCard`: `boolean`}
	_           = bytes.MinRead
)
