...
func (_m *Store) DBXFromContext(ctx context.Context) store_iface.SqlxExecutor {
	ret := _m.Called(ctx)

	var r0 store_iface.SqlxExecutor
	if rf, ok := ret.Get(0).(func(context.Context) store_iface.SqlxExecutor); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store_iface.SqlxExecutor)
		}
	}
...
// GetMasterX provides a mock function with given fields:
func (_m *Store) GetMasterX() store_iface.SqlxExecutor {
	ret := _m.Called()

	var r0 store_iface.SqlxExecutor
	if rf, ok := ret.Get(0).(func() store_iface.SqlxExecutor); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store_iface.SqlxExecutor)
...
// GetReplicaX provides a mock function with given fields:
func (_m *Store) GetReplicaX() store_iface.SqlxExecutor {
	ret := _m.Called()
