...
func (_m *WishlistStore) GetByOption(option *model.WishlistFilterOption) (*model.Wishlist, error) {
	ret := _m.Called(option)

	var r0 *model.Wishlist
	var r1 error
	if rf, ok := ret.Get(0).(func(*model.WishlistFilterOption) (*model.Wishlist, error)); ok {
		return rf(option)
	}
	if rf, ok := ret.Get(0).(func(*model.WishlistFilterOption) *model.Wishlist); ok {
		r0 = rf(option)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*model.WishlistFilterOption) error); ok {
		r1 = rf(option)
	} else {
		r1 = ret.Error(1)
	}
