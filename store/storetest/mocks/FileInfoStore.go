...
// GetWithOptions provides a mock function with given fields: options
func (_m *FileInfoStore) GetWithOptions(options model_helper.FileInfoFilterOption) (model.FileInfoSlice, error) {
	ret := _m.Called(options)

	var r0 model.FileInfoSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(model_helper.FileInfoFilterOption) (model.FileInfoSlice, error)); ok {
		return rf(options)
	}
	if rf, ok := ret.Get(0).(func(model_helper.FileInfoFilterOption) model.FileInfoSlice); ok {
		r0 = rf(options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.FileInfoSlice)
		}
	}

	if rf, ok := ret.Get(1).(func(model_helper.FileInfoFilterOption) error); ok {
		r1 = rf(options)
	} else {
		r1 = ret.Error(1)
	}
