...
func (_m *ShopStaffStore) FilterByOptions(options *model.ShopStaffFilterOptions) ([]*model.ShopStaff, error) {
	ret := _m.Called(options)

	var r0 []*model.ShopStaff
	var r1 error
	if rf, ok := ret.Get(0).(func(*model.ShopStaffFilterOptions) ([]*model.ShopStaff, error)); ok {
		return rf(options)
	}
	if rf, ok := ret.Get(0).(func(*model.ShopStaffFilterOptions) []*model.ShopStaff); ok {
		r0 = rf(options)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*model.ShopStaffFilterOptions) error); ok {
		r1 = rf(options)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ShopStaffStore) GetByOptions(options *model.ShopStaffFilterOptions) (*model.ShopStaff, error) {
	ret := _m.Called(options)
...
func (_m *ShopStaffStore) Save(shopStaff *model.ShopStaff) (*model.ShopStaff, error) {
