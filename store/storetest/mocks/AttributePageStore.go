...
func (_m *AttributePageStore) GetByOption(option *model.AttributePageFilterOption) (*model.AttributePage, error) {
	ret := _m.Called(option)

	var r0 *model.AttributePage
	var r1 error
	if rf, ok := ret.Get(0).(func(*model.AttributePageFilterOption) (*model.AttributePage, error)); ok {
		return rf(option)
	}
	if rf, ok := ret.Get(0).(func(*model.AttributePageFilterOption) *model.AttributePage); ok {
		r0 = rf(option)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.AttributePage)
	...
	if rf, ok := ret.Get(1).(func(*model.AttributePageFilterOption) error); ok {
		r1 = rf(option)
	} else {
		r1 = ret.Error(1)
	}
