...
func (_m *StaffNotificationRecipientStore) FilterByOptions(options model_helper.StaffNotificationRecipientFilterOptions) (model.StaffNotificationRecipientSlice, error) {
	ret := _m.Called(options)

	var r0 model.StaffNotificationRecipientSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(model_helper.StaffNotificationRecipientFilterOptions) (model.StaffNotificationRecipientSlice, error)); ok {
		return rf(options)
	}
	if rf, ok := ret.Get(0).(func(model_helper.StaffNotificationRecipientFilterOptions) model.StaffNotificationRecipientSlice); ok {
		r0 = rf(options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.StaffNotificationRecipientSlice)
		}
	}

	if rf, ok := ret.Get(1).(func(model_helper.StaffNotificationRecipientFilterOptions) error); ok {
		r1 = rf(options)
	} else {
		r1 = ret.Error(1)
	}
