...
func (_m *PreferenceStore) CreateIndexesIfNotExists() {
	_m.Called()
}
...
// DeleteUnusedFeatures provides a mock function with given fields:
func (_m *PreferenceStore) DeleteUnusedFeatures() {
	_m.Called()
}
