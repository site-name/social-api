...
func (_m *PluginStore) CompareAndDelete(keyVal *plugins.PluginKeyValue, oldValue []byte) (bool, error) {
	ret := _m.Called(keyVal, oldValue)

	var r0 bool
	if rf, ok := ret.Get(0).(func(*plugins.PluginKeyValue, []byte) bool); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*plugins.PluginKeyValue, []byte) error); ok {
...
func (_m *PluginStore) CompareAndSet(keyVal *plugins.PluginKeyValue, oldValue []byte) (bool, error) {
	ret := _m.Called(keyVal, oldValue)
...
func (_m *PluginStore) CreateIndexesIfNotExists() {
	_m.Called()
}
...
func (_m *PluginStore) Get(pluginID string, key string) (*plugins.PluginKeyValue, error) {
	ret := _m.Called(pluginID, key)

	var r0 *plugins.PluginKeyValue
	if rf, ok := ret.Get(0).(func(string, string) *plugins.PluginKeyValue); ok {
		r0 = rf(pluginID, key)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*plugins.PluginKeyValue)
		}
	}
...
func (_m *PluginStore) SaveOrUpdate(keyVal *plugins.PluginKeyValue) (*plugins.PluginKeyValue, error) {
	ret := _m.Called(keyVal)

	var r0 *plugins.PluginKeyValue
	if rf, ok := ret.Get(0).(func(*plugins.PluginKeyValue) *plugins.PluginKeyValue); ok {
		r0 = rf(keyVal)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*plugins.PluginKeyValue)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*plugins.PluginKeyValue) error); ok {
		r1 = rf(keyVal)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *PluginStore) SetWithOptions(pluginID string, key string, value []byte, options plugins.PluginKVSetOptions) (bool, error) {
	ret := _m.Called(pluginID, key, value, options)

	var r0 bool
	if rf, ok := ret.Get(0).(func(string, string, []byte, plugins.PluginKVSetOptions) bool); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, []byte, plugins.PluginKVSetOptions) error); ok {
