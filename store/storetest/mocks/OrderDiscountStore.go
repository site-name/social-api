...
// Upsert provides a mock function with given fields: orderDiscount
func (_m *OrderDiscountStore) Upsert(orderDiscount *product_and_discount.OrderDiscount) (*product_and_discount.OrderDiscount, error) {
	ret := _m.Called(orderDiscount)

	var r0 *product_and_discount.OrderDiscount
	if rf, ok := ret.Get(0).(func(*product_and_discount.OrderDiscount) *product_and_discount.OrderDiscount); ok {
		r0 = rf(orderDiscount)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*product_and_discount.OrderDiscount)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*product_and_discount.OrderDiscount) error); ok {
		r1 = rf(orderDiscount)
	} else {
		r1 = ret.Error(1)
	}
