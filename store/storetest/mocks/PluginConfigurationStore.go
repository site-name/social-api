...
func (_m *PluginConfigurationStore) FilterPluginConfigurations(options model_helper.PluginConfigurationFilterOptions) (model.PluginConfigurationSlice, error) {
	ret := _m.Called(options)

	var r0 model.PluginConfigurationSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(model_helper.PluginConfigurationFilterOptions) (model.PluginConfigurationSlice, error)); ok {
		return rf(options)
	}
	if rf, ok := ret.Get(0).(func(model_helper.PluginConfigurationFilterOptions) model.PluginConfigurationSlice); ok {
		r0 = rf(options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.PluginConfigurationSlice)
		}
	}

	if rf, ok := ret.Get(1).(func(model_helper.PluginConfigurationFilterOptions) error); ok {
		r1 = rf(options)
	} else {
		r1 = ret.Error(1)
	}
