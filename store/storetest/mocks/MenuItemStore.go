...
func (_m *MenuItemStore) Delete(ids []string) (int64, error) {
	ret := _m.Called(ids)
...
func (_m *MenuItemStore) FilterByOptions(options model_helper.MenuItemFilterOptions) (model.MenuItemSlice, error) {
	ret := _m.Called(options)

	var r0 model.MenuItemSlice
	var r1 error
	if rf, ok := ret.Get(0).(func(model_helper.MenuItemFilterOptions) (model.MenuItemSlice, error)); ok {
		return rf(options)
	}
	if rf, ok := ret.Get(0).(func(model_helper.MenuItemFilterOptions) model.MenuItemSlice); ok {
		r0 = rf(options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.MenuItemSlice)
		}
	}

	if rf, ok := ret.Get(1).(func(model_helper.MenuItemFilterOptions) error); ok {
		r1 = rf(options)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *MenuItemStore) GetByOptions(options model_helper.MenuItemFilterOptions) (*model.MenuItem, error) {
	ret := _m.Called(options)

	var r0 *model.MenuItem
	var r1 error
	if rf, ok := ret.Get(0).(func(model_helper.MenuItemFilterOptions) (*model.MenuItem, error)); ok {
		return rf(options)
	}
	if rf, ok := ret.Get(0).(func(model_helper.MenuItemFilterOptions) *model.MenuItem); ok {
		r0 = rf(options)
	} else {
		if ret.Get(0) != nil {
...
// Upsert provides a mock function with given fields: menuItem
func (_m *MenuItemStore) Upsert(menuItem model.MenuItem) (*model.MenuItem, error) {
