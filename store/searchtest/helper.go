...
// func (th *SearchTestHelper) addUserToTeams(user *account.User, teamIDS []string) error {
...
// func (th *SearchTestHelper) addUserToChannels(user *account.User, channelIDS []string) error {
