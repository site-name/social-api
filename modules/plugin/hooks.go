...
const (
	...
	UserHasJoinedChannelID
	UserHasLeftChannelID
	UserHasJoinedTeamID
	UserHasLeftTeamID
	ChannelHasBeenCreatedID
	FileWillBeUploadedID
	UserWillLogInID
	UserHasLoggedInID
	UserHasBeenCreatedID
	ReactionHasBeenAddedID
	ReactionHasBeenRemovedID
