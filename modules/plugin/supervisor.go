...
func newSupervisor(pluginInfo *model.BundleInfo, apiImpl API, parentLogger *slog.Logger, metrics einterfaces.MetricsInterface) (retSupervisor *supervisor, retErr error) {
	sup := supervisor{}
	defer func() {
		if retErr != nil {
			sup.Shutdown()
