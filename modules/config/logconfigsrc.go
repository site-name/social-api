...
type LogSrcListener func(old, new slog.LoggerConfiguration)
...
// Get fetches the current, cached configuration
func (src *jsonSrc) Get() slog.LoggerConfiguration {
	src.mutex.RLock()
...
func (src *jsonSrc) set(cfg slog.LoggerConfiguration) {
	src.mutex.Lock()
...
// Get fetches the current, cached configuration
func (src *fileSrc) Get() slog.LoggerConfiguration {
	src.mutex.RLock()
	defer src.mutex.RUnlock()
	return src.cfg
}
...
func (src *fileSrc) set(cfg slog.LoggerConfiguration) {
	src.mutex.Lock()
	defer src.mutex.Unlock()
...
func logTargetCfgFromJSON(data []byte) (slog.LoggerConfiguration, error) {
