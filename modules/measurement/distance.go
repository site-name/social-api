...
var (
	DISTANCE_UNIT_STRINGS    map[DistanceUnit]string  // map distance unit alias to their fullnames
	DISTANCE_UNIT_CONVERSION map[DistanceUnit]float32 // map distance unit to their according value
)
