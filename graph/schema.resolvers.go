...
func (r *mutationResolver) PaymentCapture(ctx context.Context, amount *decimal.Decimal, paymentID string) (*PaymentCapture, error) {
	panic(fmt.Errorf("not implemented"))
}

func (r *mutationResolver) PaymentRefund(ctx context.Context, amount *decimal.Decimal, paymentID string) (*PaymentRefund, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) PaymentInitialize(ctx context.Context, gateway string, paymentData *string) (*PaymentInitialize, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) OrderCapture(ctx context.Context, amount *decimal.Decimal, id string) (*OrderCapture, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) OrderRefund(ctx context.Context, amount *decimal.Decimal, id string) (*OrderRefund, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) PluginUpdate(ctx context.Context, id string, input PluginUpdateInput) (*PluginUpdate, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) RequestPasswordReset(ctx context.Context, email string, redirectURL string) (*RequestPasswordReset, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) RequestEmailChange(ctx context.Context, newEmail string, password string, redirectURL string) (*RequestEmailChange, error) {
	panic(fmt.Errorf("not implemented"))
}

func (r *mutationResolver) ConfirmEmailChange(ctx context.Context, token string) (*ConfirmEmailChange, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) AccountRequestDeletion(ctx context.Context, redirectURL string) (*AccountRequestDeletion, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) Products(ctx context.Context, filter *ProductFilterInput, sortBy *ProductOrder, channel *string, before *string, after *string, first *int, last *int) (*ProductCountableConnection, error) {
	return &ProductCountableConnection{
		PageInfo: &PageInfo{
			HasNextPage: true,
		},
		Edges: []ProductCountableEdge{
			{
				Node: &Product{
					ID:   "sdsdsdsdsd",
					Name: "This is the 1st product",
					Slug: "this-is-the-1st-product",
				},
				Cursor: "ddfdfdf",
			},
			{
				Node: &Product{
					ID:   "lkuiouretfgfg",
					Name: "This is the 2nd product",
					Slug: "this-is-the-2st-product",
				},
				Cursor: "ddfdfdf",
			},
		},
...
func (r *queryResolver) OrderByToken(ctx context.Context, token string) (*Order, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) Checkout(ctx context.Context, token *string) (*Checkout, error) {
	panic(fmt.Errorf("not implemented"))
}
