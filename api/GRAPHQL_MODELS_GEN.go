...
const (
	OrderEventsEnumDraftCreated                      OrderEventsEnum = OrderEventsEnum(model.DRAFT_CREATED)
	OrderEventsEnumDraftCreatedFromReplace           OrderEventsEnum = OrderEventsEnum(model.DRAFT_CREATED_FROM_REPLACE)
	OrderEventsEnumAddedProducts                     OrderEventsEnum = OrderEventsEnum(model.ADDED_PRODUCTS)
	OrderEventsEnumRemovedProducts                   OrderEventsEnum = OrderEventsEnum(model.REMOVED_PRODUCTS)
	OrderEventsEnumPlaced                            OrderEventsEnum = OrderEventsEnum(model.PLACED)
	OrderEventsEnumPlacedFromDraft                   OrderEventsEnum = OrderEventsEnum(model.PLACED_FROM_DRAFT)
	OrderEventsEnumOversoldItems                     OrderEventsEnum = OrderEventsEnum(model.OVERSOLD_ITEMS)
	OrderEventsEnumCanceled                          OrderEventsEnum = OrderEventsEnum(model.CANCELED_)
	OrderEventsEnumOrderMarkedAsPaid                 OrderEventsEnum = OrderEventsEnum(model.ORDER_MARKED_AS_PAID)
	OrderEventsEnumOrderFullyPaid                    OrderEventsEnum = OrderEventsEnum(model.ORDER_FULLY_PAID)
	OrderEventsEnumOrderReplacementCreated           OrderEventsEnum = OrderEventsEnum(model.ORDER_REPLACEMENT_CREATED)
	OrderEventsEnumOrderDiscountAdded                OrderEventsEnum = OrderEventsEnum(model.ORDER_DISCOUNT_ADDED)
	OrderEventsEnumOrderDiscountAutomaticallyUpdated OrderEventsEnum = OrderEventsEnum(model.ORDER_DISCOUNT_AUTOMATICALLY_UPDATED)
	OrderEventsEnumOrderDiscountUpdated              OrderEventsEnum = OrderEventsEnum(model.ORDER_DISCOUNT_UPDATED)
	OrderEventsEnumOrderDiscountDeleted              OrderEventsEnum = OrderEventsEnum(model.ORDER_DISCOUNT_DELETED)
	OrderEventsEnumOrderLineDiscountUpdated          OrderEventsEnum = OrderEventsEnum(model.ORDER_LINE_DISCOUNT_UPDATED)
	OrderEventsEnumOrderLineDiscountRemoved          OrderEventsEnum = OrderEventsEnum(model.ORDER_LINE_DISCOUNT_REMOVED)
	OrderEventsEnumUpdatedAddress                    OrderEventsEnum = OrderEventsEnum(model.UPDATED_ADDRESS)
	OrderEventsEnumEmailSent                         OrderEventsEnum = OrderEventsEnum(model.EMAIL_SENT)
	OrderEventsEnumConfirmed                         OrderEventsEnum = OrderEventsEnum(model.CONFIRMED)
	OrderEventsEnumPaymentAuthorized                 OrderEventsEnum = OrderEventsEnum(model.PAYMENT_AUTHORIZED)
	OrderEventsEnumPaymentCaptured                   OrderEventsEnum = OrderEventsEnum(model.PAYMENT_CAPTURED)
	OrderEventsEnumExternalServiceNotification       OrderEventsEnum = OrderEventsEnum(model.EXTERNAL_SERVICE_NOTIFICATION)
	OrderEventsEnumPaymentRefunded                   OrderEventsEnum = OrderEventsEnum(model.PAYMENT_REFUNDED)
	OrderEventsEnumPaymentVoided                     OrderEventsEnum = OrderEventsEnum(model.PAYMENT_VOIDED)
	OrderEventsEnumPaymentFailed                     OrderEventsEnum = OrderEventsEnum(model.PAYMENT_FAILED)
	OrderEventsEnumInvoiceRequested                  OrderEventsEnum = OrderEventsEnum(model.INVOICE_REQUESTED)
	OrderEventsEnumInvoiceGenerated                  OrderEventsEnum = OrderEventsEnum(model.INVOICE_GENERATED)
	OrderEventsEnumInvoiceUpdated                    OrderEventsEnum = OrderEventsEnum(model.INVOICE_UPDATED)
	OrderEventsEnumInvoiceSent                       OrderEventsEnum = OrderEventsEnum(model.INVOICE_SENT)
	OrderEventsEnumFulfillmentCanceled               OrderEventsEnum = OrderEventsEnum(model.FULFILLMENT_CANCELED_)
	OrderEventsEnumFulfillmentRestockedItems         OrderEventsEnum = OrderEventsEnum(model.FULFILLMENT_RESTOCKED_ITEMS)
	OrderEventsEnumFulfillmentFulfilledItems         OrderEventsEnum = OrderEventsEnum(model.FULFILLMENT_FULFILLED_ITEMS)
	OrderEventsEnumFulfillmentRefunded               OrderEventsEnum = OrderEventsEnum(model.FULFILLMENT_REFUNDED_)
	OrderEventsEnumFulfillmentReturned               OrderEventsEnum = OrderEventsEnum(model.FULFILLMENT_RETURNED_)
	OrderEventsEnumFulfillmentReplaced               OrderEventsEnum = OrderEventsEnum(model.FULFILLMENT_REPLACED_)
	OrderEventsEnumFulfillmentAwaitsApproval         OrderEventsEnum = OrderEventsEnum(model.FULFILLMENT_AWAITS_APPROVAL)
	OrderEventsEnumTrackingUpdated                   OrderEventsEnum = OrderEventsEnum(model.TRACKING_UPDATED)
	OrderEventsEnumNoteAdded                         OrderEventsEnum = OrderEventsEnum(model.NOTE_ADDED)
	OrderEventsEnumOther                             OrderEventsEnum = OrderEventsEnum(model.OTHER)
)
