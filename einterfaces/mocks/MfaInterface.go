...
func (_m *MfaInterface) Activate(user *account.User, token string) *model.AppError {
	ret := _m.Called(user, token)

	var r0 *model.AppError
	if rf, ok := ret.Get(0).(func(*account.User, string) *model.AppError); ok {
		r0 = rf(user, token)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MfaInterface) GenerateSecret(user *account.User) (string, []byte, *model.AppError) {
	ret := _m.Called(user)

	var r0 string
	if rf, ok := ret.Get(0).(func(*account.User) string); ok {
		r0 = rf(user)
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	var r1 []byte
	if rf, ok := ret.Get(1).(func(*account.User) []byte); ok {
		r1 = rf(user)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]byte)
	...
	if rf, ok := ret.Get(2).(func(*account.User) *model.AppError); ok {
		r2 = rf(user)
	} else {
		if ret.Get(2) != nil {
