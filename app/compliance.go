...
func (a *App) GetComplianceReports(page, perPage int) (compliance.Compliances, *model.AppError) {
...
func (a *App) SaveComplianceReport(job *compliance.Compliance) (*compliance.Compliance, *model.AppError) {
	...
	job.Type = compliance.ComplianceTypeAdhoc
...
func (a *App) GetComplianceReport(reportID string) (*compliance.Compliance, *model.AppError) {
	if !*a.Config().ComplianceSettings.Enable || a.Compliance() == nil {
...
func (a *App) GetComplianceFile(job *compliance.Compliance) ([]byte, *model.AppError) {
