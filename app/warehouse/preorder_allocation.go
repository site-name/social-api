...
func (s *ServiceWarehouse) DeletePreorderAllocations(transaction store_iface.SqlxExecutor, preorderAllocationIDs ...string) *model.AppError {
...
func (s *ServiceWarehouse) BulkCreate(transaction store_iface.SqlxExecutor, preorderAllocations []*model.PreorderAllocation) ([]*model.PreorderAllocation, *model.AppError) {
