...
type ProductService interface {
	...
	CategoriesByOption(option *model.CategoryFilterOption) (model.CategorySlice, *model_helper.AppError)
	...
	CollectionsByOption(option *model.CollectionFilterOption) (int64, model.CollectionSlice, *model_helper.AppError)
	...
	GetProductPriceRange(product model.Product, variants model.ProductVariantSlice, variantsChannelListing []*model.ProductVariantChannelListing, collections []*model.Collection, discounts []*model_helper.DiscountInfo, chanNel model.Channel) (*goprices.MoneyRange, *model_helper.AppError)
