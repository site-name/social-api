...
type ProductService interface {
	CreateCollectionProductRelations(transaction store_iface.SqlxTxExecutor, relations []*model.CollectionProduct) ([]*model.CollectionProduct, *model.AppError)
	// BulkUpsertProductChannelListings bulk update/inserts given product channel listings and returns them
	BulkUpsertProductChannelListings(transaction store_iface.SqlxTxExecutor, listings []*model.ProductChannelListing) ([]*model.ProductChannelListing, *model.AppError)
	...
	UpdateProductDiscountedPrice(transaction store_iface.SqlxTxExecutor, product model.Product, discounts []*model.DiscountInfo) *model.AppError
	// UpdateProductsDiscountedPrices
	UpdateProductsDiscountedPrices(transaction store_iface.SqlxTxExecutor, products []*model.Product, discounts []*model.DiscountInfo) *model.AppError
	// UpdateProductsDiscountedPricesOfDiscount
	//
	// NOTE: discount must be either *Sale or *Voucher
	UpdateProductsDiscountedPricesOfDiscount(transaction store_iface.SqlxTxExecutor, discount interface{}) *model.AppError
	...
	UpdateProductsDiscountedPricesOfCatalogues(transaction store_iface.SqlxTxExecutor, productIDs, categoryIDs, collectionIDs, variantIDs []string) *model.AppError
}
