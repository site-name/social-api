...
type ProductService interface {
	CreateCollectionProductRelations(transaction store_iface.SqlxExecutor, relations []*model.CollectionProduct) ([]*model.CollectionProduct, *model.AppError)
	// BulkUpsertProductChannelListings bulk update/inserts given product channel listings and returns them
	BulkUpsertProductChannelListings(transaction store_iface.SqlxExecutor, listings []*model.ProductChannelListing) ([]*model.ProductChannelListing, *model.AppError)
	// BulkUpsertProductVariantChannelListings tells store to bulk upserts given product variant channel listings
	BulkUpsertProductVariantChannelListings(transaction store_iface.SqlxExecutor, listings []*model.ProductVariantChannelListing) ([]*model.ProductVariantChannelListing, *model.AppError)
	...
	UpdateProductDiscountedPrice(transaction store_iface.SqlxExecutor, product model.Product, discounts []*model.DiscountInfo) *model.AppError
	// UpdateProductsDiscountedPrices
	UpdateProductsDiscountedPrices(transaction store_iface.SqlxExecutor, products []*model.Product, discounts []*model.DiscountInfo) *model.AppError
	// UpdateProductsDiscountedPricesOfDiscount
	//
	// NOTE: discount must be either *Sale or *Voucher
	UpdateProductsDiscountedPricesOfDiscount(transaction store_iface.SqlxExecutor, discount interface{}) *model.AppError
	...
	UpsertProductVariant(transaction store_iface.SqlxExecutor, variant *model.ProductVariant) (*model.ProductVariant, *model.AppError)
	...
	UpdateProductsDiscountedPricesOfCatalogues(transaction store_iface.SqlxExecutor, productIDs, categoryIDs, collectionIDs, variantIDs []string) *model.AppError
}
