...
type ProductService interface {
	...
	BulkUpsertProductChannelListings(transaction boil.ContextTransactor, listings []*model.ProductChannelListing) ([]*model.ProductChannelListing, *model_helper.AppError)
	// BulkUpsertProductVariantChannelListings tells store to bulk upserts given product variant channel listings
	BulkUpsertProductVariantChannelListings(transaction boil.ContextTransactor, listings []*model.ProductVariantChannelListing) ([]*model.ProductVariantChannelListing, *model_helper.AppError)
	...
	GetProductAvailability(product model.Product, productChannelListing *model.ProductChannelListing, variants []*model.ProductVariant, variantsChannelListing []*model.ProductVariantChannelListing, collections []*model.Collection, discounts []*model_helper.DiscountInfo, chanNel model.Channel, manager interfaces.PluginManagerInterface, countryCode model.CountryCode, localCurrency string) (*model.ProductAvailability, *model_helper.AppError)
	GetProductPriceRange(product model.Product, variants model.ProductVariants, variantsChannelListing []*model.ProductVariantChannelListing, collections []*model.Collection, discounts []*model_helper.DiscountInfo, chanNel model.Channel) (*goprices.MoneyRange, *model_helper.AppError)
