...
type CheckoutService interface {
	...
	BaseCheckoutTotal(subTotal goprices.TaxedMoney, shippingPrice goprices.TaxedMoney, discount goprices.Currencier, currency model.Currency) (*goprices.TaxedMoney, *model_helper.AppError)
