...
func (a *ServiceProduct) CalculateRevenueForVariant(
	...
	if err != nil {
		return nil, model_helper.NewAppError("CalculateRevenueForVariant", model_helper.InvalidArgumentAppErrorID, map[string]any{"Fields": "currencyCode"}, err.Error(), http.StatusBadRequest)
	}
