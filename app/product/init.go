...
func (a *AppProduct) CalculateRevenueForVariant(
...
func (a *AppProduct) DeleteCategories(categoryIDs []string, manager interface{}) *model.AppError {
...
func (a *AppProduct) CollectCategoriesTreeProducts(category *product_and_discount.Category) ([]*product_and_discount.Product, *model.AppError) {
	panic("not implemented")
}

// GetProductsIDsWithoutVariants Return list of product's ids without variants
func (a *AppProduct) GetProductsIDsWithoutVariants(productList []*product_and_discount.Product) ([]string, *model.AppError) {
