...
func (s *ServiceProduct) ProductTypesByOptions(options *model.ProductTypeFilterOption) ([]*model.ProductType, *model.AppError) {
	...
	if err != nil {
		return nil, model.NewAppError("ProductTypesByOptions", "app.product.error_finding_product_types_by_options.app_error", nil, err.Error(), http.StatusInternalServerError)
	}
