...
func (a *ServiceOrder) CommonCreateOrderEvent(transaction store_iface.SqlxTxExecutor, option *model.OrderEventOption) (*model.OrderEvent, *model.AppError) {
...
func (a *ServiceOrder) OrderDiscountsAutomaticallyUpdatedEvent(transaction store_iface.SqlxTxExecutor, ord *model.Order, changedOrderDiscounts [][2]*model.OrderDiscount) *model.AppError {
...
func (s *ServiceOrder) FulfillmentCanceledEvent(transaction store_iface.SqlxTxExecutor, orDer *model.Order, user *model.User, _ interface{}, fulfillment *model.Fulfillment) (*model.OrderEvent, *model.AppError) {
	var userID *string
	if user != nil {
		userID = &user.Id
	}
...
func (s *ServiceOrder) FulfillmentFulfilledItemsEvent(transaction store_iface.SqlxTxExecutor, orDer *model.Order, user *model.User, _ interface{}, fulfillmentLines model.FulfillmentLines) (*model.OrderEvent, *model.AppError) {
	var userID *string
	if user != nil {
		userID = &user.Id
	}
...
func (s *ServiceOrder) FulfillmentAwaitsApprovalEvent(transaction store_iface.SqlxTxExecutor, orDer *model.Order, user *model.User, _ interface{}, fulfillmentLines model.FulfillmentLines) (*model.OrderEvent, *model.AppError) {
	var userID *string
	if user != nil && model.IsValidId(user.Id) {
		userID = &user.Id
	}
...
func (s *ServiceOrder) OrderManuallyMarkedAsPaidEvent(transaction store_iface.SqlxTxExecutor, orDer model.Order, user *model.User, _ interface{}, transactionReference string) (*model.OrderEvent, *model.AppError) {
	var (
		userID     *string
		parameters = model.StringInterface{}
	)
...
func (s *ServiceOrder) DraftOrderCreatedFromReplaceEvent(transaction store_iface.SqlxTxExecutor, draftOrder model.Order, originalOrder model.Order, user *model.User, _ interface{}, lines []*model.QuantityOrderLine) (*model.OrderEvent, *model.AppError) {
	var userID *string
	if user != nil && model.IsValidId(user.Id) {
		userID = &user.Id
	}
...
func (s *ServiceOrder) FulfillmentReplacedEvent(transaction store_iface.SqlxTxExecutor, orDer model.Order, user *model.User, _ interface{}, replacedLines []*model.QuantityOrderLine) (*model.OrderEvent, *model.AppError) {
	var userID *string
...
func (s *ServiceOrder) OrderReplacementCreated(transaction store_iface.SqlxTxExecutor, originalOrder model.Order, replaceOrder *model.Order, user *model.User, _ interface{}) (*model.OrderEvent, *model.AppError) {
	var userID *string
