...
func (a *ServiceWishlist) UpsertWishlist(wishList *model.Wishlist) (*model.Wishlist, *model_helper.AppError) {
	...
	if err != nil {
		...
		return nil, model_helper.NewAppError("UpsertWishlist", "app.wishlist.error_upserting_wishlist.app_error", nil, err.Error(), statusCode)
	}
...
func (a *ServiceWishlist) WishlistByOption(option *model.WishlistFilterOption) (*model.Wishlist, *model_helper.AppError) {
	...
	if err != nil {
		...
		return nil, model_helper.NewAppError("WishlistByOption", "app.wishlist.error_finding_wishlist.app_error", nil, err.Error(), status)
	}
...
func (a *ServiceWishlist) SetUserForWishlist(wishList *model.Wishlist, userID string) (*model.Wishlist, *model_helper.AppError) {
...
func (a *ServiceWishlist) GetAllVariants(wishlistID string) ([]*model.ProductVariant, *model_helper.AppError) {
...
func (a *ServiceWishlist) AddProduct(wishlistID string, productID string) (*model.WishlistItem, *model_helper.AppError) {
...
func (a *ServiceWishlist) RemoveProduct(wishlistID string, productID string) *model_helper.AppError {
...
func (a *ServiceWishlist) AddProductVariant(wishlistID string, productVariant *model.ProductVariant) (*model.WishlistItem, *model_helper.AppError) {
	...
	if err != nil {
		return nil, model_helper.NewAppError("AddProductVariant", "app.wishlist.add_variant_to_wishlist_item.app_error", nil, err.Error(), http.StatusInternalServerError)
	}
...
func (a *ServiceWishlist) RemoveProductVariant(wishlistID string, productVariant *model.ProductVariant) *model_helper.AppError {
	...
	if err != nil {
		return model_helper.NewAppError("RemoveProductVariant", "app.wishlist.remove_product_variant_from_wishlist_item.app_error", nil, err.Error(), http.StatusInternalServerError)
	}
