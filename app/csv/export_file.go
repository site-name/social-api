...
func (s *ServiceCsv) CreateExportFile(file *csv.ExportFile) (*csv.ExportFile, *model.AppError) {
...
func (s *ServiceCsv) ExportFileById(id string) (*csv.ExportFile, *model.AppError) {
