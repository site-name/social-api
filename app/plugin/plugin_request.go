...
func (a *ServicePlugin) ServeInterPluginRequest(w http.ResponseWriter, r *http.Request, sourcePluginId, destinationPluginId string) {
	...
	if err != nil {
		a.srv.Log.Error("Access to route for non-existent plugin in inter plugin request",
