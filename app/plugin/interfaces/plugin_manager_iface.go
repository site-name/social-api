...
type PluginManagerInterface interface {
	...
	AssignTaxCodeToObjectMeta(obj any, taxCode string) (*model.TaxType, *model_helper.AppError)
	// GetTaxCodeFromObjectMeta
	//
	// NOTE: obj must be either Product or ProductType
	GetTaxCodeFromObjectMeta(obj any) (*model.TaxType, *model_helper.AppError)
	...
	CalculateCheckoutLineTotal(checkoutInfo model_helper.CheckoutInfo, lines model.CheckoutLineInfos, checkoutLineInfo model_helper.CheckoutLineInfo, address *model.Address, discounts []*model_helper.DiscountInfo) (*goprices.TaxedMoney, *model_helper.AppError)
	CalculateCheckoutLineUnitPrice(totalLinePrice goprices.TaxedMoney, quantity int, checkoutInfo model_helper.CheckoutInfo, lines model.CheckoutLineInfos, checkoutLineInfo model_helper.CheckoutLineInfo, address *model.Address, discounts []*model_helper.DiscountInfo) (*goprices.TaxedMoney, *model_helper.AppError)
	CalculateCheckoutShipping(checkoutInfo model_helper.CheckoutInfo, lines model.CheckoutLineInfos, address *model.Address, discounts []*model_helper.DiscountInfo) (*goprices.TaxedMoney, *model_helper.AppError)
	CalculateCheckoutSubTotal(checkoutInfo model_helper.CheckoutInfo, lines model.CheckoutLineInfos, address *model.Address, discounts []*model_helper.DiscountInfo) (*goprices.TaxedMoney, *model_helper.AppError)
	CalculateCheckoutTotal(checkoutInfo model_helper.CheckoutInfo, lines model.CheckoutLineInfos, address *model.Address, discounts []*model_helper.DiscountInfo) (*goprices.TaxedMoney, *model_helper.AppError)
	...
	ExternalObtainAccessTokens(pluginID string, data model_types.JSONString, req *http.Request) (*model.ExternalAccessTokens, *model_helper.AppError)
	ExternalRefresh(pluginID string, data model_types.JSONString, req *http.Request) (*model.ExternalAccessTokens, *model_helper.AppError)
	...
	GetCheckoutLineTaxRate(checkoutInfo model_helper.CheckoutInfo, lines model.CheckoutLineInfos, checkoutLineInfo model_helper.CheckoutLineInfo, address *model.Address, discounts []*model_helper.DiscountInfo, unitPrice goprices.TaxedMoney) (*decimal.Decimal, *model_helper.AppError)
	GetCheckoutShippingTaxRate(checkoutInfo model_helper.CheckoutInfo, lines model.CheckoutLineInfos, address *model.Address, discounts []*model_helper.DiscountInfo, shippingPrice goprices.TaxedMoney) (*decimal.Decimal, *model_helper.AppError)
	...
	InitializePayment(gateway string, paymentData model_types.JSONString, channelID string) *model.InitializedPaymentResponse
	...
	PreprocessOrderCreation(checkoutInfo model_helper.CheckoutInfo, discounts []*model_helper.DiscountInfo, lines model.CheckoutLineInfos) (any, *model_helper.AppError)
	...
	SaleCreated(sale model.Sale, currentCatalogue model.NodeCatalogueInfo) (any, *model_helper.AppError)
	SaleDeleted(sale model.Sale, previousCatalogue model.NodeCatalogueInfo) (any, *model_helper.AppError)
	SaleUpdated(sale model.Sale, previousCatalogue, currentCatalogue model.NodeCatalogueInfo) (any, *model_helper.AppError)
