...
func (s *ServicePlugin) FilterPluginConfigurations(options *model.PluginConfigurationFilterOptions) (model.PluginConfigurations, *model_helper.AppError) {
	if options == nil {
		return nil, model_helper.NewAppError("FilterPluginConfigurations", model_helper.InvalidArgumentAppErrorID, map[string]any{"Fields": "options"}, "", http.StatusBadRequest)
	}
