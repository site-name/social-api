...
func (a *ServiceAttribute) AttributeByOption(option *model.AttributeFilterOption) (*model.Attribute, *model_helper.AppError) {
...
func (a *ServiceAttribute) AttributesByOption(option *model.AttributeFilterOption) ([]*model.Attribute, *model_helper.AppError) {
