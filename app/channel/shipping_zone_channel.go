...
func (s *ServiceChannel) BulkUpsertShippingZoneChannels(transaction store_iface.SqlxTxExecutor, relations []*model.ShippingZoneChannel) ([]*model.ShippingZoneChannel, *model.AppError) {
...
func (s *ServiceChannel) BulkDeleteShippingZoneChannels(transaction store_iface.SqlxTxExecutor, relations []*model.ShippingZoneChannel) *model.AppError {
	err := s.srv.Store.ShippingZoneChannel().BulkDelete(transaction, relations)
	if err != nil {
