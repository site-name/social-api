...
func (o *SchemaMigration) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(schemaMigrationPrimaryKeyColumns) == 0 {
				return errors.New("model: unable to upsert schema_migrations, could not build conflict column list")
			}
