...
var OrderDiscountTableColumns = struct {
	...
	PromotionRuleID: "order_discounts.promotion_rule_id",
	VoucherID:       "order_discounts.voucher_id",
	VoucherCode:     "order_discounts.voucher_code",
	CreatedAt:       "order_discounts.created_at",
}
...
var OrderDiscountWhere = struct {
	...
	PromotionRuleID: whereHelpermodel_types_NullString{field: "\"order_discounts\".\"promotion_rule_id\""},
	VoucherID:       whereHelpermodel_types_NullString{field: "\"order_discounts\".\"voucher_id\""},
	VoucherCode:     whereHelpermodel_types_NullString{field: "\"order_discounts\".\"voucher_code\""},
	CreatedAt:       whereHelperint64{field: "\"order_discounts\".\"created_at\""},
}
...
func (r *orderDiscountR) GetPromotionRule() *PromotionRule {
	if r == nil {
		return nil
	}
...
func (r *orderDiscountR) GetVoucher() *Voucher {
	if r == nil {
		return nil
	}
	return r.Voucher
...
var (
	orderDiscountAllColumns            = []string{"id", "order_id", "type", "value_type", "value", "amount_value", "currency", "name", "translated_name", "reason", "promotion_rule_id", "voucher_id", "voucher_code", "created_at"}
	orderDiscountColumnsWithoutDefault = []string{"id", "type", "value_type", "currency", "created_at"}
	orderDiscountColumnsWithDefault    = []string{"order_id", "value", "amount_value", "name", "translated_name", "reason", "promotion_rule_id", "voucher_id", "voucher_code"}
...
func (o *OrderDiscount) PromotionRule(mods ...qm.QueryMod) promotionRuleQuery {
	queryMods := []qm.QueryMod{
...
func (o *OrderDiscount) Voucher(mods ...qm.QueryMod) voucherQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderDiscountL) LoadPromotionRule(e boil.Executor, singular bool, maybeOrderDiscount interface{}, mods queries.Applicator) error {
	var slice []*OrderDiscount
	var object *OrderDiscount
...
// loaded structs of the objects. This is for an N-1 relationship.
func (orderDiscountL) LoadVoucher(e boil.Executor, singular bool, maybeOrderDiscount interface{}, mods queries.Applicator) error {
	var slice []*OrderDiscount
	var object *OrderDiscount
...
// SetPromotionRule of the orderDiscount to the related item.
// Sets o.R.PromotionRule to related.
// Adds o to related.R.OrderDiscounts.
func (o *OrderDiscount) SetPromotionRule(exec boil.Executor, insert bool, related *PromotionRule) error {
	var err error
	if insert {
		if err = related.Insert(exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// Removes o from all passed in related items' relationships struct.
func (o *OrderDiscount) RemovePromotionRule(exec boil.Executor, related *PromotionRule) error {
	var err error
...
// SetVoucher of the orderDiscount to the related item.
// Sets o.R.Voucher to related.
// Adds o to related.R.OrderDiscounts.
func (o *OrderDiscount) SetVoucher(exec boil.Executor, insert bool, related *Voucher) error {
	var err error
	if insert {
		if err = related.Insert(exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// Removes o from all passed in related items' relationships struct.
func (o *OrderDiscount) RemoveVoucher(exec boil.Executor, related *Voucher) error {
	var err error
...
func (o OrderDiscountSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"order_discounts\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, orderDiscountPrimaryKeyColumns, len(o))
