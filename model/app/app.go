...
type App struct {
	...
	Permissions      []*model.Permission `json:"permissions" db:"-"`
...
func (a *App) IsValid() *model.AppError {
...
func (a *App) PreSave() {
	...
	if a.IsActive == nil {
		a.IsActive = model.NewBool(true)
	}
	if a.AboutApp != nil {
		a.AboutApp = model.NewString(model.SanitizeUnicode(*a.AboutApp))
	}
}
