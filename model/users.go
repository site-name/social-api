...
func (r *userR) GetGiftcardEvents() GiftcardEventSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetOrderGrantedRefunds() OrderGrantedRefundSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetPromotionEvents() PromotionEventSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetTransactionEvents() TransactionEventSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetTransactionItems() TransactionItemSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GiftcardEvents(mods ...qm.QueryMod) giftcardEventQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"giftcard_events\".\"user_id\"=?", o.ID),
	)
...
func (o *User) OrderGrantedRefunds(mods ...qm.QueryMod) orderGrantedRefundQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"order_granted_refunds\".\"user_id\"=?", o.ID),
	)
...
func (o *User) PromotionEvents(mods ...qm.QueryMod) promotionEventQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"promotion_events\".\"user_id\"=?", o.ID),
	)
...
func (o *User) TransactionEvents(mods ...qm.QueryMod) transactionEventQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"transaction_events\".\"user_id\"=?", o.ID),
	)
...
func (o *User) TransactionItems(mods ...qm.QueryMod) transactionItemQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"transaction_items\".\"user_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadGiftcardEvents(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`giftcard_events.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadOrderGrantedRefunds(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`order_granted_refunds.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadPromotionEvents(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`promotion_events.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadTransactionEvents(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`transaction_events.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadTransactionItems(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`transaction_items.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.User appropriately.
func (o *User) AddGiftcardEvents(exec boil.Executor, insert bool, related ...*GiftcardEvent) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's GiftcardEvents accordingly.
// Replaces o.R.GiftcardEvents with related.
// Sets related.R.User's GiftcardEvents accordingly.
func (o *User) SetGiftcardEvents(exec boil.Executor, insert bool, related ...*GiftcardEvent) error {
	query := "update \"giftcard_events\" set \"user_id\" = null where \"user_id\" = $1"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
...
// Sets related.R.User.
func (o *User) RemoveGiftcardEvents(exec boil.Executor, related ...*GiftcardEvent) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.User appropriately.
func (o *User) AddOrderGrantedRefunds(exec boil.Executor, insert bool, related ...*OrderGrantedRefund) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's OrderGrantedRefunds accordingly.
// Replaces o.R.OrderGrantedRefunds with related.
// Sets related.R.User's OrderGrantedRefunds accordingly.
func (o *User) SetOrderGrantedRefunds(exec boil.Executor, insert bool, related ...*OrderGrantedRefund) error {
	query := "update \"order_granted_refunds\" set \"user_id\" = null where \"user_id\" = $1"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
...
// Sets related.R.User.
func (o *User) RemoveOrderGrantedRefunds(exec boil.Executor, related ...*OrderGrantedRefund) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.User appropriately.
func (o *User) AddPromotionEvents(exec boil.Executor, insert bool, related ...*PromotionEvent) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's PromotionEvents accordingly.
// Replaces o.R.PromotionEvents with related.
// Sets related.R.User's PromotionEvents accordingly.
func (o *User) SetPromotionEvents(exec boil.Executor, insert bool, related ...*PromotionEvent) error {
	query := "update \"promotion_events\" set \"user_id\" = null where \"user_id\" = $1"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
...
// Sets related.R.User.
func (o *User) RemovePromotionEvents(exec boil.Executor, related ...*PromotionEvent) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.User appropriately.
func (o *User) AddTransactionEvents(exec boil.Executor, insert bool, related ...*TransactionEvent) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's TransactionEvents accordingly.
// Replaces o.R.TransactionEvents with related.
// Sets related.R.User's TransactionEvents accordingly.
func (o *User) SetTransactionEvents(exec boil.Executor, insert bool, related ...*TransactionEvent) error {
	query := "update \"transaction_events\" set \"user_id\" = null where \"user_id\" = $1"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
...
// Sets related.R.User.
func (o *User) RemoveTransactionEvents(exec boil.Executor, related ...*TransactionEvent) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.User appropriately.
func (o *User) AddTransactionItems(exec boil.Executor, insert bool, related ...*TransactionItem) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's TransactionItems accordingly.
// Replaces o.R.TransactionItems with related.
// Sets related.R.User's TransactionItems accordingly.
func (o *User) SetTransactionItems(exec boil.Executor, insert bool, related ...*TransactionItem) error {
	query := "update \"transaction_items\" set \"user_id\" = null where \"user_id\" = $1"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
...
// Sets related.R.User.
func (o *User) RemoveTransactionItems(exec boil.Executor, related ...*TransactionItem) error {
	if len(related) == 0 {
		return nil
	}
