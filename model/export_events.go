...
var ExportEventWhere = struct {
	...
	AppID:        whereHelpermodel_types_NullString{field: "\"export_events\".\"app_id\""},
}
...
var (
	exportEventAllColumns            = []string{"id", "date", "type", "parameters", "export_file_id", "user_id", "app_id"}
	exportEventColumnsWithoutDefault = []string{"id", "date", "type", "export_file_id"}
	exportEventColumnsWithDefault    = []string{"parameters", "user_id", "app_id"}
...
func (o ExportEventSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"export_events\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, exportEventPrimaryKeyColumns, len(o))
