...
type ShippingMethod struct {
	...
	Type                ShippingMethodType      `boil:"type" json:"type" toml:"type" yaml:"type"`
...
var ShippingMethodTableColumns = struct {
	...
	TaxClassID:          "shipping_methods.tax_class_id",
}

// Generated where

type whereHelperShippingMethodType struct{ field string }

func (w whereHelperShippingMethodType) EQ(x ShippingMethodType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperShippingMethodType) NEQ(x ShippingMethodType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperShippingMethodType) LT(x ShippingMethodType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperShippingMethodType) LTE(x ShippingMethodType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperShippingMethodType) GT(x ShippingMethodType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperShippingMethodType) GTE(x ShippingMethodType) qm.QueryMod {
...
var ShippingMethodWhere = struct {
	...
	Type                whereHelperShippingMethodType
	...
	Type:                whereHelperShippingMethodType{field: "\"shipping_methods\".\"type\""},
	...
	TaxClassID:          whereHelpermodel_types_NullString{field: "\"shipping_methods\".\"tax_class_id\""},
}
...
func (r *shippingMethodR) GetTaxClass() *TaxClass {
	if r == nil {
		return nil
	}
	return r.TaxClass
...
var (
	shippingMethodAllColumns            = []string{"id", "name", "type", "shipping_zone_id", "minimum_order_weight", "maximum_order_weight", "weight_unit", "maximum_delivery_days", "minimum_delivery_days", "description", "metadata", "private_metadata", "tax_class_id"}
	shippingMethodColumnsWithoutDefault = []string{"id", "name", "type", "shipping_zone_id", "weight_unit"}
	shippingMethodColumnsWithDefault    = []string{"minimum_order_weight", "maximum_order_weight", "maximum_delivery_days", "minimum_delivery_days", "description", "metadata", "private_metadata", "tax_class_id"}
...
func (o *ShippingMethod) TaxClass(mods ...qm.QueryMod) taxClassQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (shippingMethodL) LoadTaxClass(e boil.Executor, singular bool, maybeShippingMethod interface{}, mods queries.Applicator) error {
	var slice []*ShippingMethod
	var object *ShippingMethod
...
func (shippingMethodL) LoadCheckouts(e boil.Executor, singular bool, maybeShippingMethod interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`checkouts`),
		qm.WhereIn(`checkouts.shipping_method_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (shippingMethodL) LoadOrders(e boil.Executor, singular bool, maybeShippingMethod interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`orders`),
		qm.WhereIn(`orders.shipping_method_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (shippingMethodL) LoadShippingMethodChannelListings(e boil.Executor, singular bool, maybeShippingMethod interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`shipping_method_channel_listings.shipping_method_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (shippingMethodL) LoadShippingMethodExcludedProducts(e boil.Executor, singular bool, maybeShippingMethod interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`shipping_method_excluded_products.shipping_method_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (shippingMethodL) LoadShippingMethodPostalCodeRules(e boil.Executor, singular bool, maybeShippingMethod interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`shipping_method_postal_code_rules.shipping_method_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *ShippingMethod) SetShippingZone(exec boil.Executor, insert bool, related *ShippingZone) error {
	var err error
	if insert {
...
// SetTaxClass of the shippingMethod to the related item.
// Sets o.R.TaxClass to related.
// Adds o to related.R.ShippingMethods.
func (o *ShippingMethod) SetTaxClass(exec boil.Executor, insert bool, related *TaxClass) error {
	var err error
	if insert {
		if err = related.Insert(exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func (o *ShippingMethod) RemoveTaxClass(exec boil.Executor, related *TaxClass) error {
	var err error
...
func (o *ShippingMethod) AddCheckouts(exec boil.Executor, insert bool, related ...*Checkout) error {
	var err error
...
func (o *ShippingMethod) RemoveCheckouts(exec boil.Executor, related ...*Checkout) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		...
		if _, err = rel.Update(exec, boil.Whitelist("shipping_method_id")); err != nil {
			return err
		}
	}
	if o.R == nil {
...
// Sets related.R.ShippingMethod appropriately.
func (o *ShippingMethod) AddOrders(exec boil.Executor, insert bool, related ...*Order) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.ShippingMethodID, o.ID)
...
// Sets related.R.ShippingMethod.
func (o *ShippingMethod) RemoveOrders(exec boil.Executor, related ...*Order) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.ShippingMethod appropriately.
func (o *ShippingMethod) AddShippingMethodChannelListings(exec boil.Executor, insert bool, related ...*ShippingMethodChannelListing) error {
	var err error
	for _, rel := range related {
		if insert {
...
// Sets related.R.ShippingMethod appropriately.
func (o *ShippingMethod) AddShippingMethodExcludedProducts(exec boil.Executor, insert bool, related ...*ShippingMethodExcludedProduct) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ShippingMethodID = o.ID
...
// Sets related.R.ShippingMethod appropriately.
func (o *ShippingMethod) AddShippingMethodPostalCodeRules(exec boil.Executor, insert bool, related ...*ShippingMethodPostalCodeRule) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ShippingMethodID = o.ID
...
func (o ShippingMethodSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"shipping_methods\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, shippingMethodPrimaryKeyColumns, len(o))
