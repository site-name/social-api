...
type ProductVariant struct {
	...
	QuantityLimitPerCustomer model_types.NullInt     `boil:"quantity_limit_per_customer" json:"quantity_limit_per_customer,omitempty" toml:"quantity_limit_per_customer" yaml:"quantity_limit_per_customer,omitempty"`
...
var ProductVariantColumns = struct {
	...
	QuantityLimitPerCustomer string
	CreatedAt                string
	UpdatedAt                string
}{
	ID:                       "id",
...
var ProductVariantTableColumns = struct {
	...
	QuantityLimitPerCustomer: "product_variants.quantity_limit_per_customer",
	CreatedAt:                "product_variants.created_at",
	UpdatedAt:                "product_variants.updated_at",
}
...
var ProductVariantWhere = struct {
	...
	QuantityLimitPerCustomer whereHelpermodel_types_NullInt
	...
	QuantityLimitPerCustomer: whereHelpermodel_types_NullInt{field: "\"product_variants\".\"quantity_limit_per_customer\""},
	CreatedAt:                whereHelperint64{field: "\"product_variants\".\"created_at\""},
	UpdatedAt:                whereHelpermodel_types_NullInt64{field: "\"product_variants\".\"updated_at\""},
}
...
func (r *productVariantR) GetPromotionRuleGifts() PromotionRuleGiftSlice {
	if r == nil {
		return nil
	}
...
func (r *productVariantR) GetPromotionRuleProductVariants() PromotionRuleProductVariantSlice {
	if r == nil {
		return nil
	}
...
var (
	productVariantAllColumns            = []string{"id", "name", "product_id", "sku", "weight", "weight_unit", "track_inventory", "is_preorder", "preorder_end_date", "preorder_global_threshold", "sort_order", "metadata", "private_metadata", "quantity_limit_per_customer", "created_at", "updated_at"}
	productVariantColumnsWithoutDefault = []string{"id", "name", "product_id", "sku", "weight_unit", "is_preorder", "created_at"}
	productVariantColumnsWithDefault    = []string{"weight", "track_inventory", "preorder_end_date", "preorder_global_threshold", "sort_order", "metadata", "private_metadata", "quantity_limit_per_customer", "updated_at"}
...
func (o *ProductVariant) PromotionRuleGifts(mods ...qm.QueryMod) promotionRuleGiftQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"promotion_rule_gifts\".\"product_variant_id\"=?", o.ID),
	)
...
func (o *ProductVariant) PromotionRuleProductVariants(mods ...qm.QueryMod) promotionRuleProductVariantQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"promotion_rule_product_variants\".\"product_variant_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (productVariantL) LoadPromotionRuleGifts(e boil.Executor, singular bool, maybeProductVariant interface{}, mods queries.Applicator) error {
	var slice []*ProductVariant
	var object *ProductVariant
	...
	query := NewQuery(
		...
		qm.WhereIn(`promotion_rule_gifts.product_variant_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (productVariantL) LoadPromotionRuleProductVariants(e boil.Executor, singular bool, maybeProductVariant interface{}, mods queries.Applicator) error {
	var slice []*ProductVariant
	var object *ProductVariant
	...
	query := NewQuery(
		...
		qm.WhereIn(`promotion_rule_product_variants.product_variant_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.ProductVariant appropriately.
func (o *ProductVariant) AddPromotionRuleGifts(exec boil.Executor, insert bool, related ...*PromotionRuleGift) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ProductVariantID = o.ID
...
// Sets related.R.ProductVariant appropriately.
func (o *ProductVariant) AddPromotionRuleProductVariants(exec boil.Executor, insert bool, related ...*PromotionRuleProductVariant) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ProductVariantID = o.ID
...
func (o ProductVariantSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"product_variants\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, productVariantPrimaryKeyColumns, len(o))
