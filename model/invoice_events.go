...
var InvoiceEventWhere = struct {
	...
	AppID:      whereHelpermodel_types_NullString{field: "\"invoice_events\".\"app_id\""},
}
...
var (
	invoiceEventAllColumns            = []string{"id", "created_at", "type", "invoice_id", "order_id", "user_id", "parameters", "app_id"}
	invoiceEventColumnsWithoutDefault = []string{"id", "created_at", "type"}
	invoiceEventColumnsWithDefault    = []string{"invoice_id", "order_id", "user_id", "parameters", "app_id"}
...
func (o InvoiceEventSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"invoice_events\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, invoiceEventPrimaryKeyColumns, len(o))
