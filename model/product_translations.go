...
var (
	...
	productTranslationColumnsWithoutDefault = []string{"id", "language_code", "product_id", "name", "description"}
	productTranslationColumnsWithDefault    = []string{"seo_title", "seo_description"}
...
func (o ProductTranslationSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"product_translations\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, productTranslationPrimaryKeyColumns, len(o))
