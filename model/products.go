...
var ProductTableColumns = struct {
	...
	SearchDocument:       "products.search_document",
	SearchVector:         "products.search_vector",
	SearchIndexDirty:     "products.search_index_dirty",
...
var ProductWhere = struct {
	...
	Description:          whereHelpermodel_types_JSONString{field: "\"products\".\"description\""},
	...
	Metadata:             whereHelpermodel_types_JSONString{field: "\"products\".\"metadata\""},
	PrivateMetadata:      whereHelpermodel_types_JSONString{field: "\"products\".\"private_metadata\""},
	SeoTitle:             whereHelperstring{field: "\"products\".\"seo_title\""},
	SeoDescription:       whereHelperstring{field: "\"products\".\"seo_description\""},
	SearchDocument:       whereHelpermodel_types_NullString{field: "\"products\".\"search_document\""},
	SearchVector:         whereHelpermodel_types_NullString{field: "\"products\".\"search_vector\""},
	SearchIndexDirty:     whereHelpermodel_types_NullBool{field: "\"products\".\"search_index_dirty\""},
	TaxClassID:           whereHelpermodel_types_NullString{field: "\"products\".\"tax_class_id\""},
}
...
func (r *productR) GetTaxClass() *TaxClass {
	if r == nil {
		return nil
	}
	return r.TaxClass
...
var (
	productAllColumns            = []string{"id", "name", "slug", "description", "description_plain_text", "category_id", "created_at", "updated_at", "charge_taxes", "weight", "weight_unit", "default_variant_id", "rating", "metadata", "private_metadata", "seo_title", "seo_description", "search_document", "search_vector", "search_index_dirty", "tax_class_id"}
	...
	productColumnsWithDefault    = []string{"description", "charge_taxes", "weight", "default_variant_id", "rating", "metadata", "private_metadata", "search_document", "search_vector", "search_index_dirty", "tax_class_id"}
...
func (o *Product) TaxClass(mods ...qm.QueryMod) taxClassQuery {
...
func (productL) LoadTaxClass(e boil.Executor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
...
func (o *Product) RemoveTaxClass(exec boil.Executor, related *TaxClass) error {
	var err error
...
func (o ProductSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"products\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, productPrimaryKeyColumns, len(o))
