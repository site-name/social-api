...
func (z *User) Msgsize() (s int) {
	...
	s += 12 + msgp.StringPrefixSize + len(z.AuthService) + 14 + msgp.BoolSize + 9 + msgp.StringPrefixSize + len(z.Nickname) + 6 + msgp.StringPrefixSize + len(z.Roles) + 6 + z.Props.Msgsize() + 12 + z.NotifyProps.Msgsize() + 19 + msgp.Int64Size + 18 + msgp.Int64Size + 15 + msgp.IntSize + 7 + msgp.StringPrefixSize + len(z.Locale) + 9 + z.Timezone.Msgsize() + 10 + msgp.BoolSize + 10 + msgp.StringPrefixSize + len(z.MfaSecret) + 9 + msgp.Int64Size + 9 + msgp.Int64Size + 9 + msgp.Int64Size + 9 + msgp.BoolSize + 5
	if z.Note == nil {
		s += msgp.NilSize
	} else {
