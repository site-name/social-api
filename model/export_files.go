...
var ExportFileWhere = struct {
	...
	AppID:       whereHelpermodel_types_NullString{field: "\"export_files\".\"app_id\""},
}
...
var (
	exportFileAllColumns            = []string{"id", "user_id", "content_file", "created_at", "updated_at", "app_id"}
	exportFileColumnsWithoutDefault = []string{"id", "created_at", "updated_at"}
	exportFileColumnsWithDefault    = []string{"user_id", "content_file", "app_id"}
...
func (o ExportFileSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"export_files\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, exportFilePrimaryKeyColumns, len(o))
