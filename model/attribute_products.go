...
func (q attributeProductQuery) One(ctx context.Context, exec boil.ContextExecutor) (*AttributeProduct, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for attribute_products")
	}
...
func FindAttributeProduct(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*AttributeProduct, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from attribute_products")
	}
...
func (o *AttributeProduct) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into attribute_products")
	}
...
func (o *AttributeProduct) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update attribute_products, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for attribute_products")
	}
...
func (q attributeProductQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for attribute_products")
	}
...
func (o AttributeProductSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all attributeProduct")
	}
	return rowsAff, nil
}
...
func (o *AttributeProduct) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("model: unable to upsert attribute_products, could not build update column list")
		}
...
func (o *AttributeProduct) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for attribute_products")
	}
...
func (q attributeProductQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for attribute_products")
	}
...
func AttributeProductExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if attribute_products exists")
	}
