...
func (z *Address_) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	...
	for zb0001 > 0 {
		...
		case "StreetAddress1":
			z.StreetAddress1, err = dc.ReadString()
			if err != nil {
				err = msgp.WrapError(err, "StreetAddress1")
				return
			}
		case "StreetAddress2":
			if dc.IsNil() {
				err = dc.ReadNil()
				if err != nil {
					err = msgp.WrapError(err, "StreetAddress2")
					return
				}
				z.StreetAddress2 = nil
			} else {
				if z.StreetAddress2 == nil {
					z.StreetAddress2 = new(string)
				}
				*z.StreetAddress2, err = dc.ReadString()
				if err != nil {
					err = msgp.WrapError(err, "StreetAddress2")
					return
				}
		...
		case "CityArea":
			if dc.IsNil() {
				err = dc.ReadNil()
				if err != nil {
					err = msgp.WrapError(err, "CityArea")
					return
				}
				z.CityArea = nil
			} else {
				if z.CityArea == nil {
					z.CityArea = new(string)
				}
				*z.CityArea, err = dc.ReadString()
				if err != nil {
					err = msgp.WrapError(err, "CityArea")
					return
				}
		...
		case "CountryArea":
			z.CountryArea, err = dc.ReadString()
			if err != nil {
				err = msgp.WrapError(err, "CountryArea")
				return
			}
		case "Phone":
...
func (z *Address_) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 15
	// write "Id"
	err = en.Append(0x8f, 0xa2, 0x49, 0x64)
	if err != nil {
		return
	}
	...
	// write "CompanyName"
	err = en.Append(0xab, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x4e, 0x61, 0x6d, 0x65)
	if err != nil {
		return
	}
	if z.CompanyName == nil {
	...
	// write "StreetAddress1"
	err = en.Append(0xae, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x31)
	if err != nil {
		return
	}
	err = en.WriteString(z.StreetAddress1)
	if err != nil {
		err = msgp.WrapError(err, "StreetAddress1")
		return
	}
	// write "StreetAddress2"
	err = en.Append(0xae, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32)
	if err != nil {
		return
	}
	if z.StreetAddress2 == nil {
		...
		err = en.WriteString(*z.StreetAddress2)
		if err != nil {
			err = msgp.WrapError(err, "StreetAddress2")
			return
		}
	...
	// write "CityArea"
	err = en.Append(0xa8, 0x43, 0x69, 0x74, 0x79, 0x41, 0x72, 0x65, 0x61)
	if err != nil {
		return
	}
	if z.CityArea == nil {
	...
	// write "PostalCode"
	err = en.Append(0xaa, 0x50, 0x6f, 0x73, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x64, 0x65)
	if err != nil {
		return
	}
	...
	// write "CountryArea"
	err = en.Append(0xab, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x41, 0x72, 0x65, 0x61)
	if err != nil {
		return
	}
	err = en.WriteString(z.CountryArea)
	if err != nil {
		err = msgp.WrapError(err, "CountryArea")
		return
	}
...
func (z *Address_) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 15
	// string "Id"
	o = append(o, 0x8f, 0xa2, 0x49, 0x64)
	...
	// string "CompanyName"
	o = append(o, 0xab, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x4e, 0x61, 0x6d, 0x65)
	if z.CompanyName == nil {
		o = msgp.AppendNil(o)
	} else {
	...
	o = append(o, 0xae, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x31)
	o = msgp.AppendString(o, z.StreetAddress1)
	// string "StreetAddress2"
	o = append(o, 0xae, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32)
	if z.StreetAddress2 == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendString(o, *z.StreetAddress2)
	}
	// string "City"
	o = append(o, 0xa4, 0x43, 0x69, 0x74, 0x79)
	o = msgp.AppendString(o, z.City)
	// string "CityArea"
	o = append(o, 0xa8, 0x43, 0x69, 0x74, 0x79, 0x41, 0x72, 0x65, 0x61)
	if z.CityArea == nil {
		o = msgp.AppendNil(o)
	} else {
		o = msgp.AppendString(o, *z.CityArea)
	}
	// string "PostalCode"
	o = append(o, 0xaa, 0x50, 0x6f, 0x73, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x64, 0x65)
	o = msgp.AppendString(o, z.PostalCode)
	// string "Country"
	o = append(o, 0xa7, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79)
	o = msgp.AppendString(o, z.Country)
	// string "CountryArea"
	o = append(o, 0xab, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x41, 0x72, 0x65, 0x61)
	o = msgp.AppendString(o, z.CountryArea)
	// string "Phone"
...
func (z *Address_) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	...
	for zb0001 > 0 {
		...
		case "StreetAddress1":
			z.StreetAddress1, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "StreetAddress1")
				return
			}
		case "StreetAddress2":
			if msgp.IsNil(bts) {
				...
				*z.StreetAddress2, bts, err = msgp.ReadStringBytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "StreetAddress2")
					return
				}
		...
		case "CityArea":
			if msgp.IsNil(bts) {
				...
				*z.CityArea, bts, err = msgp.ReadStringBytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "CityArea")
					return
				}
		...
		case "CountryArea":
			z.CountryArea, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "CountryArea")
				return
			}
...
func (z *Address_) Msgsize() (s int) {
	s = 1 + 3 + msgp.StringPrefixSize + len(z.Id) + 10 + msgp.StringPrefixSize + len(z.FirstName) + 9 + msgp.StringPrefixSize + len(z.LastName) + 12
	if z.CompanyName == nil {
		s += msgp.NilSize
	} else {
		s += msgp.StringPrefixSize + len(*z.CompanyName)
	}
	s += 15 + msgp.StringPrefixSize + len(z.StreetAddress1) + 15
	if z.StreetAddress2 == nil {
		s += msgp.NilSize
	} else {
		s += msgp.StringPrefixSize + len(*z.StreetAddress2)
	}
	s += 5 + msgp.StringPrefixSize + len(z.City) + 9
	if z.CityArea == nil {
		s += msgp.NilSize
	} else {
		s += msgp.StringPrefixSize + len(*z.CityArea)
	}
	s += 11 + msgp.StringPrefixSize + len(z.PostalCode) + 8 + msgp.StringPrefixSize + len(z.Country) + 12 + msgp.StringPrefixSize + len(z.CountryArea) + 6 + msgp.StringPrefixSize + len(z.Phone) + 9 + msgp.Int64Size + 9 + msgp.Int64Size + 9 + msgp.Int64Size
	return
}
...
func (z *User) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "Addresses":
			...
			if cap(z.Addresses) >= int(zb0005) {
				z.Addresses = (z.Addresses)[:zb0005]
			} else {
				z.Addresses = make([]*Address_, zb0005)
			}
			for za0007 := range z.Addresses {
				if dc.IsNil() {
					err = dc.ReadNil()
					if err != nil {
						err = msgp.WrapError(err, "Addresses", za0007)
						return
					}
					z.Addresses[za0007] = nil
				} else {
					if z.Addresses[za0007] == nil {
						z.Addresses[za0007] = new(Address_)
					}
					err = z.Addresses[za0007].DecodeMsg(dc)
					if err != nil {
						err = msgp.WrapError(err, "Addresses", za0007)
						return
					}
		...
		case "ModelMetadata":
			if dc.IsNil() {
				...
				if z.ModelMetadata == nil {
					z.ModelMetadata = new(ModelMetadata)
				}
...
func (z *User) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 35
	// write "Id"
	err = en.Append(0xde, 0x0, 0x23, 0xa2, 0x49, 0x64)
	if err != nil {
		return
	}
	err = en.WriteString(z.Id)
	...
	for za0007 := range z.Addresses {
		if z.Addresses[za0007] == nil {
			...
			err = z.Addresses[za0007].EncodeMsg(en)
			if err != nil {
				err = msgp.WrapError(err, "Addresses", za0007)
				return
			}
...
func (z *User) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 35
	// string "Id"
	o = append(o, 0xde, 0x0, 0x23, 0xa2, 0x49, 0x64)
	o = msgp.AppendString(o, z.Id)
	...
	for za0007 := range z.Addresses {
		if z.Addresses[za0007] == nil {
			...
			o, err = z.Addresses[za0007].MarshalMsg(o)
			if err != nil {
				err = msgp.WrapError(err, "Addresses", za0007)
				return
			}
		...
		case "Addresses":
			...
			for za0007 := range z.Addresses {
				if msgp.IsNil(bts) {
					...
					bts, err = z.Addresses[za0007].UnmarshalMsg(bts)
					if err != nil {
						err = msgp.WrapError(err, "Addresses", za0007)
						return
					}
...
func (z *User) Msgsize() (s int) {
	s = 3 + 3 + msgp.StringPrefixSize + len(z.Id) + 25 + msgp.StringPrefixSize + len(z.DefaultShippingAddressID) + 24 + msgp.StringPrefixSize + len(z.DefaultBillingAddressID) + 9 + msgp.StringPrefixSize + len(z.Username) + 9 + msgp.StringPrefixSize + len(z.Password) + 9
	if z.AuthData == nil {
		s += msgp.NilSize
	} else {
		s += msgp.StringPrefixSize + len(*z.AuthData)
	}
	s += 12 + msgp.StringPrefixSize + len(z.AuthService) + 6 + msgp.StringPrefixSize + len(z.Email) + 14 + msgp.BoolSize + 9 + msgp.StringPrefixSize + len(z.Nickname) + 10 + msgp.StringPrefixSize + len(z.FirstName) + 9 + msgp.StringPrefixSize + len(z.LastName) + 6 + msgp.StringPrefixSize + len(z.Roles) + 6 + msgp.MapHeaderSize
	if z.Props != nil {
		for za0001, za0002 := range z.Props {
			_ = za0002
			s += msgp.StringPrefixSize + len(za0001) + msgp.StringPrefixSize + len(za0002)
	...
	s += 10 + msgp.BoolSize + 10 + msgp.StringPrefixSize + len(z.MfaSecret) + 9 + msgp.Int64Size + 9 + msgp.Int64Size + 9 + msgp.Int64Size + 8 + msgp.BoolSize + 9 + msgp.BoolSize + 5 + msgp.StringPrefixSize + len(z.Note) + 10 + msgp.ArrayHeaderSize
	for za0007 := range z.Addresses {
		if z.Addresses[za0007] == nil {
			s += msgp.NilSize
		} else {
			s += z.Addresses[za0007].Msgsize()
		}
	}
	s += 12 + msgp.StringPrefixSize + len(z.JwtTokenKey) + 15 + msgp.Int64Size + 17 + msgp.StringPrefixSize + len(z.TermsOfServiceId) + 23 + msgp.Int64Size + 20 + msgp.BoolSize + 14
	if z.ModelMetadata == nil {
		s += msgp.NilSize
	} else {
		s += z.ModelMetadata.Msgsize()
	}
	return
}
