...
func (q shopQuery) One(exec boil.Executor) (*Shop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for shops")
	}
...
func FindShop(exec boil.Executor, iD string, selectCols ...string) (*Shop, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from shops")
	}
...
func (o *Shop) Insert(exec boil.Executor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into shops")
	}
...
func (o *Shop) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update shops, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for shops")
	}
...
func (q shopQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for shops")
	}
...
func (o ShopSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all shop")
	}
	return rowsAff, nil
}
...
func (o *Shop) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("model: unable to upsert shops, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(shopPrimaryKeyColumns) == 0 {
				return errors.New("model: unable to upsert shops, could not build conflict column list")
			}
...
func (o *Shop) Delete(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for shops")
	}
...
func (q shopQuery) DeleteAll(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for shops")
	}
...
func (o ShopSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"shops\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, shopPrimaryKeyColumns, len(o))
...
func ShopExists(exec boil.Executor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if shops exists")
	}
