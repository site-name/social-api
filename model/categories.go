...
var CategoryWhere = struct {
	...
	Description:        whereHelpermodel_types_JSONString{field: "\"categories\".\"description\""},
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (categoryL) LoadProducts(e boil.Executor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
...
func (o CategorySlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"categories\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, categoryPrimaryKeyColumns, len(o))
