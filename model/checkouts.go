...
type Checkout struct {
	...
	CompletingStartedAt       model_types.NullInt64   `boil:"completing_started_at" json:"completing_started_at,omitempty" toml:"completing_started_at" yaml:"completing_started_at,omitempty"`
	LastTransactionModifiedAt model_types.NullInt64   `boil:"last_transaction_modified_at" json:"last_transaction_modified_at,omitempty" toml:"last_transaction_modified_at" yaml:"last_transaction_modified_at,omitempty"`
	AutomaticallyRefundable   bool                    `boil:"automatically_refundable" json:"automatically_refundable" toml:"automatically_refundable" yaml:"automatically_refundable"`
	...
	BaseTotalAmount           decimal.Decimal         `boil:"base_total_amount" json:"base_total_amount" toml:"base_total_amount" yaml:"base_total_amount"`
	...
	BaseSubtotalAmount        decimal.Decimal         `boil:"base_subtotal_amount" json:"base_subtotal_amount" toml:"base_subtotal_amount" yaml:"base_subtotal_amount"`
	...
	AuthorizeStatus           CheckoutAuthorizeStatus `boil:"authorize_status" json:"authorize_status" toml:"authorize_status" yaml:"authorize_status"`
	ChargeStatus              CheckoutChargeStatus    `boil:"charge_status" json:"charge_status" toml:"charge_status" yaml:"charge_status"`
	PriceExpiration           model_types.NullInt64   `boil:"price_expiration" json:"price_expiration,omitempty" toml:"price_expiration" yaml:"price_expiration,omitempty"`
	...
	IsVoucherUsageIncreased   bool                    `boil:"is_voucher_usage_increased" json:"is_voucher_usage_increased" toml:"is_voucher_usage_increased" yaml:"is_voucher_usage_increased"`
...
var CheckoutColumns = struct {
	...
	CreatedAt                 string
	UpdatedAt                 string
	CompletingStartedAt       string
	LastTransactionModifiedAt string
	AutomaticallyRefundable   string
	UserID                    string
	Email                     string
	Quantity                  string
	ChannelID                 string
	...
	VoucherCode               string
	IsVoucherUsageIncreased   string
	RedirectURL               string
	TrackingCode              string
	LanguageCode              string
	TaxExemption              string
	...
	CompletingStartedAt:       "completing_started_at",
	LastTransactionModifiedAt: "last_transaction_modified_at",
	AutomaticallyRefundable:   "automatically_refundable",
	UserID:                    "user_id",
	Email:                     "email",
	Quantity:                  "quantity",
	...
	IsVoucherUsageIncreased:   "is_voucher_usage_increased",
...
var CheckoutTableColumns = struct {
	...
	CompletingStartedAt:       "checkouts.completing_started_at",
	LastTransactionModifiedAt: "checkouts.last_transaction_modified_at",
	AutomaticallyRefundable:   "checkouts.automatically_refundable",
	...
	TotalNetAmount:            "checkouts.total_net_amount",
	TotalGrossAmount:          "checkouts.total_gross_amount",
	BaseTotalAmount:           "checkouts.base_total_amount",
	SubtotalNetAmount:         "checkouts.subtotal_net_amount",
	SubtotalGrossAmount:       "checkouts.subtotal_gross_amount",
	BaseSubtotalAmount:        "checkouts.base_subtotal_amount",
	ShippingPriceNetAmount:    "checkouts.shipping_price_net_amount",
	ShippingPriceGrossAmount:  "checkouts.shipping_price_gross_amount",
	ShippingTaxRate:           "checkouts.shipping_tax_rate",
	AuthorizeStatus:           "checkouts.authorize_status",
	ChargeStatus:              "checkouts.charge_status",
	PriceExpiration:           "checkouts.price_expiration",
	Note:                      "checkouts.note",
	...
	IsVoucherUsageIncreased:   "checkouts.is_voucher_usage_increased",
	RedirectURL:               "checkouts.redirect_url",
	TrackingCode:              "checkouts.tracking_code",
	LanguageCode:              "checkouts.language_code",
	TaxExemption:              "checkouts.tax_exemption",
	TaxError:                  "checkouts.tax_error",
...
type whereHelperCheckoutAuthorizeStatus struct{ field string }

func (w whereHelperCheckoutAuthorizeStatus) EQ(x CheckoutAuthorizeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperCheckoutAuthorizeStatus) NEQ(x CheckoutAuthorizeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperCheckoutAuthorizeStatus) LT(x CheckoutAuthorizeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperCheckoutAuthorizeStatus) LTE(x CheckoutAuthorizeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperCheckoutAuthorizeStatus) GT(x CheckoutAuthorizeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperCheckoutAuthorizeStatus) GTE(x CheckoutAuthorizeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperCheckoutAuthorizeStatus) IN(slice []CheckoutAuthorizeStatus) qm.QueryMod {
...
func (w whereHelperCheckoutAuthorizeStatus) NIN(slice []CheckoutAuthorizeStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
type whereHelperCheckoutChargeStatus struct{ field string }

func (w whereHelperCheckoutChargeStatus) EQ(x CheckoutChargeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperCheckoutChargeStatus) NEQ(x CheckoutChargeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperCheckoutChargeStatus) LT(x CheckoutChargeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperCheckoutChargeStatus) LTE(x CheckoutChargeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperCheckoutChargeStatus) GT(x CheckoutChargeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperCheckoutChargeStatus) GTE(x CheckoutChargeStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperCheckoutChargeStatus) IN(slice []CheckoutChargeStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
func (w whereHelperCheckoutChargeStatus) NIN(slice []CheckoutChargeStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var CheckoutWhere = struct {
	...
	CompletingStartedAt       whereHelpermodel_types_NullInt64
	LastTransactionModifiedAt whereHelpermodel_types_NullInt64
	AutomaticallyRefundable   whereHelperbool
	...
	AuthorizeStatus           whereHelperCheckoutAuthorizeStatus
	ChargeStatus              whereHelperCheckoutChargeStatus
	PriceExpiration           whereHelpermodel_types_NullInt64
	...
	IsVoucherUsageIncreased   whereHelperbool
	...
	CompletingStartedAt:       whereHelpermodel_types_NullInt64{field: "\"checkouts\".\"completing_started_at\""},
	LastTransactionModifiedAt: whereHelpermodel_types_NullInt64{field: "\"checkouts\".\"last_transaction_modified_at\""},
	AutomaticallyRefundable:   whereHelperbool{field: "\"checkouts\".\"automatically_refundable\""},
	...
	TotalNetAmount:            whereHelperdecimal_Decimal{field: "\"checkouts\".\"total_net_amount\""},
	TotalGrossAmount:          whereHelperdecimal_Decimal{field: "\"checkouts\".\"total_gross_amount\""},
	BaseTotalAmount:           whereHelperdecimal_Decimal{field: "\"checkouts\".\"base_total_amount\""},
	SubtotalNetAmount:         whereHelperdecimal_Decimal{field: "\"checkouts\".\"subtotal_net_amount\""},
	SubtotalGrossAmount:       whereHelperdecimal_Decimal{field: "\"checkouts\".\"subtotal_gross_amount\""},
	BaseSubtotalAmount:        whereHelperdecimal_Decimal{field: "\"checkouts\".\"base_subtotal_amount\""},
	ShippingPriceNetAmount:    whereHelperdecimal_Decimal{field: "\"checkouts\".\"shipping_price_net_amount\""},
	ShippingPriceGrossAmount:  whereHelperdecimal_Decimal{field: "\"checkouts\".\"shipping_price_gross_amount\""},
	ShippingTaxRate:           whereHelperdecimal_Decimal{field: "\"checkouts\".\"shipping_tax_rate\""},
	AuthorizeStatus:           whereHelperCheckoutAuthorizeStatus{field: "\"checkouts\".\"authorize_status\""},
	ChargeStatus:              whereHelperCheckoutChargeStatus{field: "\"checkouts\".\"charge_status\""},
	PriceExpiration:           whereHelpermodel_types_NullInt64{field: "\"checkouts\".\"price_expiration\""},
	...
	IsVoucherUsageIncreased:   whereHelperbool{field: "\"checkouts\".\"is_voucher_usage_increased\""},
	...
	TaxExemption:              whereHelperbool{field: "\"checkouts\".\"tax_exemption\""},
	TaxError:                  whereHelpermodel_types_NullString{field: "\"checkouts\".\"tax_error\""},
...
func (r *checkoutR) GetCheckoutDiscounts() CheckoutDiscountSlice {
	if r == nil {
		return nil
	}
...
func (r *checkoutR) GetTransactionItems() TransactionItemSlice {
	if r == nil {
		return nil
	}
...
var (
	checkoutAllColumns            = []string{"token", "created_at", "updated_at", "completing_started_at", "last_transaction_modified_at", "automatically_refundable", "user_id", "email", "quantity", "channel_id", "billing_address_id", "shipping_address_id", "shipping_method_id", "collection_point_id", "total_net_amount", "total_gross_amount", "base_total_amount", "subtotal_net_amount", "subtotal_gross_amount", "base_subtotal_amount", "shipping_price_net_amount", "shipping_price_gross_amount", "shipping_tax_rate", "authorize_status", "charge_status", "price_expiration", "note", "currency", "country", "discount_amount", "discount_name", "translated_discount_name", "voucher_code", "is_voucher_usage_increased", "redirect_url", "tracking_code", "language_code", "tax_exemption", "tax_error", "metadata", "private_metadata"}
	...
	checkoutColumnsWithDefault    = []string{"completing_started_at", "last_transaction_modified_at", "automatically_refundable", "user_id", "billing_address_id", "shipping_address_id", "shipping_method_id", "collection_point_id", "total_net_amount", "total_gross_amount", "base_total_amount", "subtotal_net_amount", "subtotal_gross_amount", "base_subtotal_amount", "shipping_price_net_amount", "shipping_price_gross_amount", "shipping_tax_rate", "authorize_status", "charge_status", "price_expiration", "discount_amount", "discount_name", "translated_discount_name", "voucher_code", "is_voucher_usage_increased", "redirect_url", "tracking_code", "tax_exemption", "tax_error", "metadata", "private_metadata"}
...
func (o *Checkout) CheckoutDiscounts(mods ...qm.QueryMod) checkoutDiscountQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"checkout_discounts\".\"checkout_id\"=?", o.Token),
	)
...
func (o *Checkout) TransactionItems(mods ...qm.QueryMod) transactionItemQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"transaction_items\".\"checkout_id\"=?", o.Token),
	)
...
func (checkoutL) LoadCheckoutDiscounts(e boil.Executor, singular bool, maybeCheckout interface{}, mods queries.Applicator) error {
	var slice []*Checkout
	var object *Checkout
	...
	query := NewQuery(
		...
		qm.WhereIn(`checkout_discounts.checkout_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (checkoutL) LoadTransactionItems(e boil.Executor, singular bool, maybeCheckout interface{}, mods queries.Applicator) error {
	var slice []*Checkout
	var object *Checkout
	...
	query := NewQuery(
		...
		qm.WhereIn(`transaction_items.checkout_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Checkout) AddCheckoutDiscounts(exec boil.Executor, insert bool, related ...*CheckoutDiscount) error {
	var err error
...
// Sets o.R.Checkout's CheckoutDiscounts accordingly.
// Replaces o.R.CheckoutDiscounts with related.
// Sets related.R.Checkout's CheckoutDiscounts accordingly.
func (o *Checkout) SetCheckoutDiscounts(exec boil.Executor, insert bool, related ...*CheckoutDiscount) error {
	query := "update \"checkout_discounts\" set \"checkout_id\" = null where \"checkout_id\" = $1"
...
func (o *Checkout) RemoveCheckoutDiscounts(exec boil.Executor, related ...*CheckoutDiscount) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.Checkout appropriately.
func (o *Checkout) AddTransactionItems(exec boil.Executor, insert bool, related ...*TransactionItem) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.CheckoutID, o.Token)
			...
			values := []interface{}{o.Token, rel.Token}
...
// checkout replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Checkout's TransactionItems accordingly.
// Replaces o.R.TransactionItems with related.
// Sets related.R.Checkout's TransactionItems accordingly.
func (o *Checkout) SetTransactionItems(exec boil.Executor, insert bool, related ...*TransactionItem) error {
	query := "update \"transaction_items\" set \"checkout_id\" = null where \"checkout_id\" = $1"
	values := []interface{}{o.Token}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
...
// Sets related.R.Checkout.
func (o *Checkout) RemoveTransactionItems(exec boil.Executor, related ...*TransactionItem) error {
	if len(related) == 0 {
		return nil
	}
...
func (o CheckoutSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"checkouts\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, checkoutPrimaryKeyColumns, len(o))
