...
func (o *AssignedProductAttribute) SetAssignment(exec boil.Executor, insert bool, related *AttributeProduct) error {
	var err error
	if insert {
...
func (o *AssignedProductAttribute) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
