...
type Payment struct {
	...
	Partial            bool                   `boil:"partial" json:"partial" toml:"partial" yaml:"partial"`
...
var PaymentWhere = struct {
	...
	Partial:            whereHelperbool{field: "\"payments\".\"partial\""},
...
var (
	paymentAllColumns            = []string{"id", "gateway", "partial", "is_active", "to_confirm", "created_at", "updated_at", "charge_status", "token", "total", "captured_amount", "currency", "checkout_id", "order_id", "billing_email", "billing_first_name", "billing_last_name", "billing_company_name", "billing_address1", "billing_address2", "billing_city", "billing_city_area", "billing_postal_code", "billing_country_code", "billing_country_area", "cc_first_digits", "cc_last_digits", "cc_brand", "cc_exp_month", "cc_exp_year", "payment_method_type", "customer_ip_address", "extra_data", "return_url", "psp_reference", "store_payment_method", "metadata", "private_metadata"}
	paymentColumnsWithoutDefault = []string{"id", "gateway", "partial", "to_confirm", "created_at", "updated_at", "charge_status", "token", "currency", "billing_email", "billing_first_name", "billing_last_name", "billing_company_name", "billing_address1", "billing_address2", "billing_city", "billing_city_area", "billing_postal_code", "billing_country_code", "billing_country_area", "cc_first_digits", "cc_last_digits", "cc_brand", "payment_method_type", "extra_data", "store_payment_method"}
	paymentColumnsWithDefault    = []string{"is_active", "total", "captured_amount", "checkout_id", "order_id", "cc_exp_month", "cc_exp_year", "customer_ip_address", "return_url", "psp_reference", "metadata", "private_metadata"}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(paymentPrimaryKeyColumns) == 0 {
				return errors.New("model: unable to upsert payments, could not build conflict column list")
			}
...
func (o PaymentSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"payments\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, paymentPrimaryKeyColumns, len(o))
