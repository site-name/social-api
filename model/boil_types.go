...
const (
	AllocationStrategyPrioritizeSortingOrder AllocationStrategy = "prioritize_sorting_order"
	AllocationStrategyPrioritizeHighStock    AllocationStrategy = "prioritize_high_stock"
)

func AllAllocationStrategy() []AllocationStrategy {
	return []AllocationStrategy{
		AllocationStrategyPrioritizeSortingOrder,
		AllocationStrategyPrioritizeHighStock,
	}
}

func (e AllocationStrategy) IsValid() error {
	switch e {
	case AllocationStrategyPrioritizeSortingOrder, AllocationStrategyPrioritizeHighStock:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e AllocationStrategy) String() string {
	return string(e)
}

func (e AllocationStrategy) Ordinal() int {
	switch e {
	case AllocationStrategyPrioritizeSortingOrder:
		return 0
	case AllocationStrategyPrioritizeHighStock:
		return 1
...
type MarkAsPaidStrategy string

// Enum values for MarkAsPaidStrategy
const (
	MarkAsPaidStrategyTransactionFlow MarkAsPaidStrategy = "transaction_flow"
	MarkAsPaidStrategyPaymentFlow     MarkAsPaidStrategy = "payment_flow"
)

func AllMarkAsPaidStrategy() []MarkAsPaidStrategy {
	return []MarkAsPaidStrategy{
		MarkAsPaidStrategyTransactionFlow,
		MarkAsPaidStrategyPaymentFlow,
	}
}

func (e MarkAsPaidStrategy) IsValid() error {
	switch e {
	case MarkAsPaidStrategyTransactionFlow, MarkAsPaidStrategyPaymentFlow:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e MarkAsPaidStrategy) String() string {
	return string(e)
}

func (e MarkAsPaidStrategy) Ordinal() int {
	switch e {
	case MarkAsPaidStrategyTransactionFlow:
		return 0
	case MarkAsPaidStrategyPaymentFlow:
		return 1
...
type TransactionFlowStrategy string

// Enum values for TransactionFlowStrategy
const (
	TransactionFlowStrategyAuthorization TransactionFlowStrategy = "authorization"
	TransactionFlowStrategyCharge        TransactionFlowStrategy = "charge"
)

func AllTransactionFlowStrategy() []TransactionFlowStrategy {
	return []TransactionFlowStrategy{
		TransactionFlowStrategyAuthorization,
		TransactionFlowStrategyCharge,
	}
}

func (e TransactionFlowStrategy) IsValid() error {
	switch e {
	case TransactionFlowStrategyAuthorization, TransactionFlowStrategyCharge:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e TransactionFlowStrategy) String() string {
	return string(e)
}

func (e TransactionFlowStrategy) Ordinal() int {
	switch e {
	case TransactionFlowStrategyAuthorization:
		return 0
	case TransactionFlowStrategyCharge:
		return 1
...
// Enum values for DiscountType
const (
	DiscountTypeSale           DiscountType = "sale"
	DiscountTypePromotion      DiscountType = "promotion"
	DiscountTypeOrderPromotion DiscountType = "order_promotion"
	DiscountTypeManual         DiscountType = "manual"
)

func AllDiscountType() []DiscountType {
	return []DiscountType{
		DiscountTypeSale,
		DiscountTypePromotion,
		DiscountTypeOrderPromotion,
		DiscountTypeManual,
	}
}

func (e DiscountType) IsValid() error {
	switch e {
	case DiscountTypeSale, DiscountTypePromotion, DiscountTypeOrderPromotion, DiscountTypeManual:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e DiscountType) Ordinal() int {
	switch e {
	case DiscountTypeSale:
		return 0
	case DiscountTypePromotion:
		return 1
	case DiscountTypeOrderPromotion:
		return 2
...
// NullDiscountType is a nullable DiscountType enum type. It supports SQL and JSON serialization.
type NullDiscountType struct {
	Val   DiscountType
	Valid bool
}

// NullDiscountTypeFrom creates a new DiscountType that will never be blank.
func NullDiscountTypeFrom(v DiscountType) NullDiscountType {
	return NewNullDiscountType(v, true)
}

// NullDiscountTypeFromPtr creates a new NullDiscountType that be null if s is nil.
func NullDiscountTypeFromPtr(v *DiscountType) NullDiscountType {
	if v == nil {
		return NewNullDiscountType("", false)
	}
	return NewNullDiscountType(*v, true)
}

// NewNullDiscountType creates a new NullDiscountType
func NewNullDiscountType(v DiscountType, valid bool) NullDiscountType {
	return NullDiscountType{
		Val:   v,
		Valid: valid,
	}
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (e *NullDiscountType) UnmarshalJSON(data []byte) error {
	if bytes.Equal(data, null.NullBytes) {
		e.Val = ""
		e.Valid = false
		return nil
...
// MarshalJSON implements json.Marshaler.
func (e NullDiscountType) MarshalJSON() ([]byte, error) {
	if !e.Valid {
		return null.NullBytes, nil
	}
	return json.Marshal(e.Val)
...
// MarshalText implements encoding.TextMarshaler.
func (e NullDiscountType) MarshalText() ([]byte, error) {
	if !e.Valid {
		return []byte{}, nil
	}
	return []byte(e.Val), nil
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (e *NullDiscountType) UnmarshalText(text []byte) error {
	if text == nil || len(text) == 0 {
		e.Valid = false
		return nil
	}

	e.Val = DiscountType(text)
	e.Valid = true
	return nil
}

// SetValid changes this NullDiscountType value and also sets it to be non-null.
func (e *NullDiscountType) SetValid(v DiscountType) {
	e.Val = v
	e.Valid = true
}

// Ptr returns a pointer to this NullDiscountType value, or a nil pointer if this NullDiscountType is null.
func (e NullDiscountType) Ptr() *DiscountType {
	if !e.Valid {
		return nil
	}
	return &e.Val
...
// IsZero returns true for null types.
func (e NullDiscountType) IsZero() bool {
	return !e.Valid
}

// Scan implements the Scanner interface.
func (e *NullDiscountType) Scan(value interface{}) error {
	if value == nil {
		e.Val, e.Valid = "", false
		return nil
	}
...
// Value implements the driver Valuer interface.
func (e NullDiscountType) Value() (driver.Value, error) {
	if !e.Valid {
		return nil, nil
	}
	return string(e.Val), nil
...
type CheckoutAuthorizeStatus string

// Enum values for CheckoutAuthorizeStatus
const (
	CheckoutAuthorizeStatusNone    CheckoutAuthorizeStatus = "none"
	CheckoutAuthorizeStatusPartial CheckoutAuthorizeStatus = "partial"
	CheckoutAuthorizeStatusFull    CheckoutAuthorizeStatus = "full"
)

func AllCheckoutAuthorizeStatus() []CheckoutAuthorizeStatus {
	return []CheckoutAuthorizeStatus{
		CheckoutAuthorizeStatusNone,
		CheckoutAuthorizeStatusPartial,
		CheckoutAuthorizeStatusFull,
	}
}

func (e CheckoutAuthorizeStatus) IsValid() error {
	switch e {
	case CheckoutAuthorizeStatusNone, CheckoutAuthorizeStatusPartial, CheckoutAuthorizeStatusFull:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e CheckoutAuthorizeStatus) String() string {
	return string(e)
}

func (e CheckoutAuthorizeStatus) Ordinal() int {
	switch e {
	case CheckoutAuthorizeStatusNone:
		return 0
	case CheckoutAuthorizeStatusPartial:
		return 1
	case CheckoutAuthorizeStatusFull:
		return 2
...
type CheckoutChargeStatus string

// Enum values for CheckoutChargeStatus
const (
	CheckoutChargeStatusNone        CheckoutChargeStatus = "none"
	CheckoutChargeStatusPartial     CheckoutChargeStatus = "partial"
	CheckoutChargeStatusFull        CheckoutChargeStatus = "full"
	CheckoutChargeStatusOvercharged CheckoutChargeStatus = "overcharged"
)

func AllCheckoutChargeStatus() []CheckoutChargeStatus {
	return []CheckoutChargeStatus{
		CheckoutChargeStatusNone,
		CheckoutChargeStatusPartial,
		CheckoutChargeStatusFull,
		CheckoutChargeStatusOvercharged,
	}
}

func (e CheckoutChargeStatus) IsValid() error {
	switch e {
	case CheckoutChargeStatusNone, CheckoutChargeStatusPartial, CheckoutChargeStatusFull, CheckoutChargeStatusOvercharged:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e CheckoutChargeStatus) String() string {
	return string(e)
}

func (e CheckoutChargeStatus) Ordinal() int {
	switch e {
	case CheckoutChargeStatusNone:
		return 0
	case CheckoutChargeStatusPartial:
		return 1
	case CheckoutChargeStatusFull:
		return 2
	case CheckoutChargeStatusOvercharged:
		return 3
...
const (
	...
	OrderEventTypeTransactionEvent                    OrderEventType = "transaction_event"
	OrderEventTypeTransactionChargeRequested          OrderEventType = "transaction_charge_requested"
	OrderEventTypeTransactionRefundRequested          OrderEventType = "transaction_refund_requested"
	OrderEventTypeOrderLineDiscountRemoved            OrderEventType = "order_line_discount_removed"
	OrderEventTypeTransactionCancelRequested          OrderEventType = "transaction_cancel_requested"
	OrderEventTypeTransactionMarkAsPaidFailed         OrderEventType = "transaction_mark_as_paid_failed"
	...
	OrderEventTypePlacedAutomaticallyFromPaidCheckout OrderEventType = "placed_automatically_from_paid_checkout"
	OrderEventTypeExpired                             OrderEventType = "expired"
...
func AllOrderEventType() []OrderEventType {
	return []OrderEventType{
		...
		OrderEventTypeTransactionEvent,
		OrderEventTypeTransactionChargeRequested,
		OrderEventTypeTransactionRefundRequested,
		OrderEventTypeOrderLineDiscountRemoved,
		OrderEventTypeTransactionCancelRequested,
		OrderEventTypeTransactionMarkAsPaidFailed,
		...
		OrderEventTypeOther,
		OrderEventTypePlacedAutomaticallyFromPaidCheckout,
		OrderEventTypeExpired,
...
func (e OrderEventType) IsValid() error {
	switch e {
	case OrderEventTypeConfirmed, OrderEventTypeDraftCreated, OrderEventTypeDraftCreatedFromReplace, OrderEventTypeAddedProducts, OrderEventTypeRemovedProducts, OrderEventTypePlaced, OrderEventTypePlacedFromDraft, OrderEventTypeOversoldItems, OrderEventTypeCanceled, OrderEventTypeOrderMarkedAsPaid, OrderEventTypeOrderFullyPaid, OrderEventTypeOrderDiscountAdded, OrderEventTypeOrderDiscountAutomaticallyUpdated, OrderEventTypeOrderDiscountUpdated, OrderEventTypeOrderDiscountDeleted, OrderEventTypeOrderLineDiscountUpdated, OrderEventTypeTransactionEvent, OrderEventTypeTransactionChargeRequested, OrderEventTypeTransactionRefundRequested, OrderEventTypeOrderLineDiscountRemoved, OrderEventTypeTransactionCancelRequested, OrderEventTypeTransactionMarkAsPaidFailed, OrderEventTypeOrderLineProductDeleted, OrderEventTypeOrderLineVariantDeleted, OrderEventTypeUpdatedAddress, OrderEventTypeEmailSent, OrderEventTypePaymentAuthorized, OrderEventTypePaymentCaptured, OrderEventTypePaymentRefunded, OrderEventTypePaymentVoided, OrderEventTypePaymentFailed, OrderEventTypeExternalServiceNotification, OrderEventTypeInvoiceRequested, OrderEventTypeInvoiceGenerated, OrderEventTypeInvoiceUpdated, OrderEventTypeInvoiceSent, OrderEventTypeFulfillmentCanceled, OrderEventTypeFulfillmentRestockedItems, OrderEventTypeFulfillmentFulfilledItems, OrderEventTypeFulfillmentRefunded, OrderEventTypeFulfillmentReturned, OrderEventTypeFulfillmentReplaced, OrderEventTypeFulfillmentAwaitsApproval, OrderEventTypeTrackingUpdated, OrderEventTypeNoteAdded, OrderEventTypeOther, OrderEventTypePlacedAutomaticallyFromPaidCheckout, OrderEventTypeExpired, OrderEventTypeOrderReplacementCreated:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e OrderEventType) Ordinal() int {
	...
	case OrderEventTypeOrderLineDiscountUpdated:
		return 15
	case OrderEventTypeTransactionEvent:
		return 16
	case OrderEventTypeTransactionChargeRequested:
		return 17
	case OrderEventTypeTransactionRefundRequested:
		return 18
	case OrderEventTypeOrderLineDiscountRemoved:
		return 19
	case OrderEventTypeTransactionCancelRequested:
		return 20
	case OrderEventTypeTransactionMarkAsPaidFailed:
		return 21
	...
	case OrderEventTypeOther:
		return 45
	case OrderEventTypePlacedAutomaticallyFromPaidCheckout:
		return 46
	case OrderEventTypeExpired:
		return 47
...
type OrderGrantedRefundStatus string

// Enum values for OrderGrantedRefundStatus
const (
	OrderGrantedRefundStatusNone    OrderGrantedRefundStatus = "none"
	OrderGrantedRefundStatusPending OrderGrantedRefundStatus = "pending"
	OrderGrantedRefundStatusSuccess OrderGrantedRefundStatus = "success"
	OrderGrantedRefundStatusFailure OrderGrantedRefundStatus = "failure"
)

func AllOrderGrantedRefundStatus() []OrderGrantedRefundStatus {
	return []OrderGrantedRefundStatus{
		OrderGrantedRefundStatusNone,
		OrderGrantedRefundStatusPending,
		OrderGrantedRefundStatusSuccess,
		OrderGrantedRefundStatusFailure,
	}
}

func (e OrderGrantedRefundStatus) IsValid() error {
	switch e {
	case OrderGrantedRefundStatusNone, OrderGrantedRefundStatusPending, OrderGrantedRefundStatusSuccess, OrderGrantedRefundStatusFailure:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e OrderGrantedRefundStatus) String() string {
	return string(e)
}

func (e OrderGrantedRefundStatus) Ordinal() int {
	switch e {
	case OrderGrantedRefundStatusNone:
		return 0
	case OrderGrantedRefundStatusPending:
		return 1
	case OrderGrantedRefundStatusSuccess:
		return 2
	case OrderGrantedRefundStatusFailure:
		return 3
...
// NullOrderGrantedRefundStatus is a nullable OrderGrantedRefundStatus enum type. It supports SQL and JSON serialization.
type NullOrderGrantedRefundStatus struct {
	Val   OrderGrantedRefundStatus
	Valid bool
}

// NullOrderGrantedRefundStatusFrom creates a new OrderGrantedRefundStatus that will never be blank.
func NullOrderGrantedRefundStatusFrom(v OrderGrantedRefundStatus) NullOrderGrantedRefundStatus {
	return NewNullOrderGrantedRefundStatus(v, true)
}

// NullOrderGrantedRefundStatusFromPtr creates a new NullOrderGrantedRefundStatus that be null if s is nil.
func NullOrderGrantedRefundStatusFromPtr(v *OrderGrantedRefundStatus) NullOrderGrantedRefundStatus {
	if v == nil {
		return NewNullOrderGrantedRefundStatus("", false)
	}
	return NewNullOrderGrantedRefundStatus(*v, true)
}

// NewNullOrderGrantedRefundStatus creates a new NullOrderGrantedRefundStatus
func NewNullOrderGrantedRefundStatus(v OrderGrantedRefundStatus, valid bool) NullOrderGrantedRefundStatus {
	return NullOrderGrantedRefundStatus{
		Val:   v,
		Valid: valid,
	}
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (e *NullOrderGrantedRefundStatus) UnmarshalJSON(data []byte) error {
	if bytes.Equal(data, null.NullBytes) {
		e.Val = ""
		e.Valid = false
		return nil
...
// MarshalJSON implements json.Marshaler.
func (e NullOrderGrantedRefundStatus) MarshalJSON() ([]byte, error) {
	if !e.Valid {
		return null.NullBytes, nil
	}
	return json.Marshal(e.Val)
...
// MarshalText implements encoding.TextMarshaler.
func (e NullOrderGrantedRefundStatus) MarshalText() ([]byte, error) {
	if !e.Valid {
		return []byte{}, nil
	}
	return []byte(e.Val), nil
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (e *NullOrderGrantedRefundStatus) UnmarshalText(text []byte) error {
	if text == nil || len(text) == 0 {
		e.Valid = false
		return nil
	}

	e.Val = OrderGrantedRefundStatus(text)
	e.Valid = true
	return nil
}

// SetValid changes this NullOrderGrantedRefundStatus value and also sets it to be non-null.
func (e *NullOrderGrantedRefundStatus) SetValid(v OrderGrantedRefundStatus) {
	e.Val = v
	e.Valid = true
}

// Ptr returns a pointer to this NullOrderGrantedRefundStatus value, or a nil pointer if this NullOrderGrantedRefundStatus is null.
func (e NullOrderGrantedRefundStatus) Ptr() *OrderGrantedRefundStatus {
	if !e.Valid {
		return nil
	}
	return &e.Val
...
// IsZero returns true for null types.
func (e NullOrderGrantedRefundStatus) IsZero() bool {
	return !e.Valid
}

// Scan implements the Scanner interface.
func (e *NullOrderGrantedRefundStatus) Scan(value interface{}) error {
	if value == nil {
		e.Val, e.Valid = "", false
		return nil
	}
...
// Value implements the driver Valuer interface.
func (e NullOrderGrantedRefundStatus) Value() (driver.Value, error) {
	if !e.Valid {
		return nil, nil
	}
	return string(e.Val), nil
...
func (e OrderStatus) IsValid() error {
	switch e {
	case OrderStatusDraft, OrderStatusUnconfirmed, OrderStatusUnfulfilled, OrderStatusPartiallyFulfilled, OrderStatusFulfilled, OrderStatusPartiallyReturned, OrderStatusReturned, OrderStatusCanceled, OrderStatusExpired:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
type OrderAuthorizeStatus string

// Enum values for OrderAuthorizeStatus
const (
	OrderAuthorizeStatusNone    OrderAuthorizeStatus = "none"
	OrderAuthorizeStatusPartial OrderAuthorizeStatus = "partial"
	OrderAuthorizeStatusFull    OrderAuthorizeStatus = "full"
)

func AllOrderAuthorizeStatus() []OrderAuthorizeStatus {
	return []OrderAuthorizeStatus{
		OrderAuthorizeStatusNone,
		OrderAuthorizeStatusPartial,
		OrderAuthorizeStatusFull,
	}
}

func (e OrderAuthorizeStatus) IsValid() error {
	switch e {
	case OrderAuthorizeStatusNone, OrderAuthorizeStatusPartial, OrderAuthorizeStatusFull:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e OrderAuthorizeStatus) String() string {
	return string(e)
}

func (e OrderAuthorizeStatus) Ordinal() int {
	switch e {
	case OrderAuthorizeStatusNone:
		return 0
	case OrderAuthorizeStatusPartial:
		return 1
	case OrderAuthorizeStatusFull:
		return 2
...
type OrderChargeStatus string

// Enum values for OrderChargeStatus
const (
	OrderChargeStatusNone        OrderChargeStatus = "none"
	OrderChargeStatusPartial     OrderChargeStatus = "partial"
	OrderChargeStatusFull        OrderChargeStatus = "full"
	OrderChargeStatusOvercharged OrderChargeStatus = "overcharged"
)

func AllOrderChargeStatus() []OrderChargeStatus {
	return []OrderChargeStatus{
		OrderChargeStatusNone,
		OrderChargeStatusPartial,
		OrderChargeStatusFull,
		OrderChargeStatusOvercharged,
	}
}

func (e OrderChargeStatus) IsValid() error {
	switch e {
	case OrderChargeStatusNone, OrderChargeStatusPartial, OrderChargeStatusFull, OrderChargeStatusOvercharged:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e OrderChargeStatus) String() string {
	return string(e)
}

func (e OrderChargeStatus) Ordinal() int {
	switch e {
	case OrderChargeStatusNone:
		return 0
	case OrderChargeStatusPartial:
		return 1
	case OrderChargeStatusFull:
		return 2
	case OrderChargeStatusOvercharged:
		return 3
...
const (
	...
	OrderOriginBulkCreate OrderOrigin = "bulk_create"
)
...
func AllOrderOrigin() []OrderOrigin {
	return []OrderOrigin{
		...
		OrderOriginDraft,
		OrderOriginReissue,
		OrderOriginBulkCreate,
	}
}

func (e OrderOrigin) IsValid() error {
	switch e {
	case OrderOriginCheckout, OrderOriginDraft, OrderOriginReissue, OrderOriginBulkCreate:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
// Enum values for PromotionEventType
const (
	PromotionEventTypePromotionCreated PromotionEventType = "promotion_created"
	PromotionEventTypePromotionUpdated PromotionEventType = "promotion_updated"
	PromotionEventTypePromotionStarted PromotionEventType = "promotion_started"
	PromotionEventTypePromotionEnded   PromotionEventType = "promotion_ended"
	PromotionEventTypeRuleCreated      PromotionEventType = "rule_created"
	PromotionEventTypeRuleUpdated      PromotionEventType = "rule_updated"
	PromotionEventTypeRuleDeleted      PromotionEventType = "rule_deleted"
)

func AllPromotionEventType() []PromotionEventType {
	return []PromotionEventType{
		PromotionEventTypePromotionCreated,
		PromotionEventTypePromotionUpdated,
		PromotionEventTypePromotionStarted,
		PromotionEventTypePromotionEnded,
		PromotionEventTypeRuleCreated,
		PromotionEventTypeRuleUpdated,
		PromotionEventTypeRuleDeleted,
	}
}

func (e PromotionEventType) IsValid() error {
	switch e {
	case PromotionEventTypePromotionCreated, PromotionEventTypePromotionUpdated, PromotionEventTypePromotionStarted, PromotionEventTypePromotionEnded, PromotionEventTypeRuleCreated, PromotionEventTypeRuleUpdated, PromotionEventTypeRuleDeleted:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e PromotionEventType) String() string {
	return string(e)
}

func (e PromotionEventType) Ordinal() int {
	switch e {
	case PromotionEventTypePromotionCreated:
		return 0
	case PromotionEventTypePromotionUpdated:
		return 1
	case PromotionEventTypePromotionStarted:
		return 2
	case PromotionEventTypePromotionEnded:
		return 3
	case PromotionEventTypeRuleCreated:
		return 4
	case PromotionEventTypeRuleUpdated:
		return 5
	case PromotionEventTypeRuleDeleted:
		return 6
...
type RewardValueType string

// Enum values for RewardValueType
const (
	RewardValueTypeFixed      RewardValueType = "fixed"
	RewardValueTypePercentage RewardValueType = "percentage"
)

func AllRewardValueType() []RewardValueType {
	return []RewardValueType{
		RewardValueTypeFixed,
		RewardValueTypePercentage,
	}
}

func (e RewardValueType) IsValid() error {
	switch e {
	case RewardValueTypeFixed, RewardValueTypePercentage:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e RewardValueType) String() string {
	return string(e)
}

func (e RewardValueType) Ordinal() int {
	switch e {
	case RewardValueTypeFixed:
		return 0
	case RewardValueTypePercentage:
		return 1
...
// NullRewardValueType is a nullable RewardValueType enum type. It supports SQL and JSON serialization.
type NullRewardValueType struct {
	Val   RewardValueType
	Valid bool
}

// NullRewardValueTypeFrom creates a new RewardValueType that will never be blank.
func NullRewardValueTypeFrom(v RewardValueType) NullRewardValueType {
	return NewNullRewardValueType(v, true)
}

// NullRewardValueTypeFromPtr creates a new NullRewardValueType that be null if s is nil.
func NullRewardValueTypeFromPtr(v *RewardValueType) NullRewardValueType {
	if v == nil {
		return NewNullRewardValueType("", false)
	}
	return NewNullRewardValueType(*v, true)
}

// NewNullRewardValueType creates a new NullRewardValueType
func NewNullRewardValueType(v RewardValueType, valid bool) NullRewardValueType {
	return NullRewardValueType{
		Val:   v,
		Valid: valid,
	}
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (e *NullRewardValueType) UnmarshalJSON(data []byte) error {
	if bytes.Equal(data, null.NullBytes) {
		e.Val = ""
		e.Valid = false
		return nil
...
// MarshalJSON implements json.Marshaler.
func (e NullRewardValueType) MarshalJSON() ([]byte, error) {
	if !e.Valid {
		return null.NullBytes, nil
	}
	return json.Marshal(e.Val)
...
// MarshalText implements encoding.TextMarshaler.
func (e NullRewardValueType) MarshalText() ([]byte, error) {
	if !e.Valid {
		return []byte{}, nil
	}
	return []byte(e.Val), nil
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (e *NullRewardValueType) UnmarshalText(text []byte) error {
	if text == nil || len(text) == 0 {
		e.Valid = false
		return nil
	}

	e.Val = RewardValueType(text)
	e.Valid = true
	return nil
}

// SetValid changes this NullRewardValueType value and also sets it to be non-null.
func (e *NullRewardValueType) SetValid(v RewardValueType) {
	e.Val = v
	e.Valid = true
}

// Ptr returns a pointer to this NullRewardValueType value, or a nil pointer if this NullRewardValueType is null.
func (e NullRewardValueType) Ptr() *RewardValueType {
	if !e.Valid {
		return nil
	}
	return &e.Val
...
// IsZero returns true for null types.
func (e NullRewardValueType) IsZero() bool {
	return !e.Valid
}

// Scan implements the Scanner interface.
func (e *NullRewardValueType) Scan(value interface{}) error {
	if value == nil {
		e.Val, e.Valid = "", false
		return nil
	}
...
// Value implements the driver Valuer interface.
func (e NullRewardValueType) Value() (driver.Value, error) {
	if !e.Valid {
		return nil, nil
	}
	return string(e.Val), nil
...
// Enum values for RewardType
const (
	RewardTypeSubtotalDiscount RewardType = "subtotal_discount"
	RewardTypeGift             RewardType = "gift"
)

func AllRewardType() []RewardType {
	return []RewardType{
		RewardTypeSubtotalDiscount,
		RewardTypeGift,
	}
}

func (e RewardType) IsValid() error {
	switch e {
	case RewardTypeSubtotalDiscount, RewardTypeGift:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e RewardType) Ordinal() int {
	switch e {
	case RewardTypeSubtotalDiscount:
		return 0
	case RewardTypeGift:
		return 1
...
// NullRewardType is a nullable RewardType enum type. It supports SQL and JSON serialization.
type NullRewardType struct {
	Val   RewardType
	Valid bool
}

// NullRewardTypeFrom creates a new RewardType that will never be blank.
func NullRewardTypeFrom(v RewardType) NullRewardType {
	return NewNullRewardType(v, true)
}

// NullRewardTypeFromPtr creates a new NullRewardType that be null if s is nil.
func NullRewardTypeFromPtr(v *RewardType) NullRewardType {
	if v == nil {
		return NewNullRewardType("", false)
	}
	return NewNullRewardType(*v, true)
}

// NewNullRewardType creates a new NullRewardType
func NewNullRewardType(v RewardType, valid bool) NullRewardType {
	return NullRewardType{
		Val:   v,
		Valid: valid,
	}
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (e *NullRewardType) UnmarshalJSON(data []byte) error {
	if bytes.Equal(data, null.NullBytes) {
		e.Val = ""
		e.Valid = false
		return nil
...
// MarshalJSON implements json.Marshaler.
func (e NullRewardType) MarshalJSON() ([]byte, error) {
	if !e.Valid {
		return null.NullBytes, nil
	}
	return json.Marshal(e.Val)
...
// MarshalText implements encoding.TextMarshaler.
func (e NullRewardType) MarshalText() ([]byte, error) {
	if !e.Valid {
		return []byte{}, nil
	}
	return []byte(e.Val), nil
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (e *NullRewardType) UnmarshalText(text []byte) error {
	if text == nil || len(text) == 0 {
		e.Valid = false
		return nil
	}

	e.Val = RewardType(text)
	e.Valid = true
	return nil
}

// SetValid changes this NullRewardType value and also sets it to be non-null.
func (e *NullRewardType) SetValid(v RewardType) {
	e.Val = v
	e.Valid = true
}

// Ptr returns a pointer to this NullRewardType value, or a nil pointer if this NullRewardType is null.
func (e NullRewardType) Ptr() *RewardType {
	if !e.Valid {
		return nil
	}
	return &e.Val
...
// IsZero returns true for null types.
func (e NullRewardType) IsZero() bool {
	return !e.Valid
}

// Scan implements the Scanner interface.
func (e *NullRewardType) Scan(value interface{}) error {
	if value == nil {
		e.Val, e.Valid = "", false
		return nil
	}
...
// Value implements the driver Valuer interface.
func (e NullRewardType) Value() (driver.Value, error) {
	if !e.Valid {
		return nil, nil
	}
	return string(e.Val), nil
...
// Enum values for PromotionType
const (
	PromotionTypeCatalogue PromotionType = "catalogue"
	PromotionTypeOrder     PromotionType = "order"
)

func AllPromotionType() []PromotionType {
	return []PromotionType{
		PromotionTypeCatalogue,
		PromotionTypeOrder,
	}
}

func (e PromotionType) IsValid() error {
	switch e {
	case PromotionTypeCatalogue, PromotionTypeOrder:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e PromotionType) Ordinal() int {
	switch e {
	case PromotionTypeCatalogue:
		return 0
	case PromotionTypeOrder:
		return 1
...
type TaxCalculationStrategy string

// Enum values for TaxCalculationStrategy
const (
	TaxCalculationStrategyFlatRates TaxCalculationStrategy = "flat_rates"
	TaxCalculationStrategyTaxApp    TaxCalculationStrategy = "tax_app"
)

func AllTaxCalculationStrategy() []TaxCalculationStrategy {
	return []TaxCalculationStrategy{
		TaxCalculationStrategyFlatRates,
		TaxCalculationStrategyTaxApp,
	}
}

func (e TaxCalculationStrategy) IsValid() error {
	switch e {
	case TaxCalculationStrategyFlatRates, TaxCalculationStrategyTaxApp:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e TaxCalculationStrategy) String() string {
	return string(e)
}

func (e TaxCalculationStrategy) Ordinal() int {
	switch e {
	case TaxCalculationStrategyFlatRates:
		return 0
	case TaxCalculationStrategyTaxApp:
		return 1
...
// NullTaxCalculationStrategy is a nullable TaxCalculationStrategy enum type. It supports SQL and JSON serialization.
type NullTaxCalculationStrategy struct {
	Val   TaxCalculationStrategy
	Valid bool
}

// NullTaxCalculationStrategyFrom creates a new TaxCalculationStrategy that will never be blank.
func NullTaxCalculationStrategyFrom(v TaxCalculationStrategy) NullTaxCalculationStrategy {
	return NewNullTaxCalculationStrategy(v, true)
}

// NullTaxCalculationStrategyFromPtr creates a new NullTaxCalculationStrategy that be null if s is nil.
func NullTaxCalculationStrategyFromPtr(v *TaxCalculationStrategy) NullTaxCalculationStrategy {
	if v == nil {
		return NewNullTaxCalculationStrategy("", false)
	}
	return NewNullTaxCalculationStrategy(*v, true)
}

// NewNullTaxCalculationStrategy creates a new NullTaxCalculationStrategy
func NewNullTaxCalculationStrategy(v TaxCalculationStrategy, valid bool) NullTaxCalculationStrategy {
	return NullTaxCalculationStrategy{
		Val:   v,
		Valid: valid,
	}
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (e *NullTaxCalculationStrategy) UnmarshalJSON(data []byte) error {
	if bytes.Equal(data, null.NullBytes) {
		e.Val = ""
		e.Valid = false
		return nil
...
// MarshalJSON implements json.Marshaler.
func (e NullTaxCalculationStrategy) MarshalJSON() ([]byte, error) {
	if !e.Valid {
		return null.NullBytes, nil
	}
	return json.Marshal(e.Val)
...
// MarshalText implements encoding.TextMarshaler.
func (e NullTaxCalculationStrategy) MarshalText() ([]byte, error) {
	if !e.Valid {
		return []byte{}, nil
	}
	return []byte(e.Val), nil
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (e *NullTaxCalculationStrategy) UnmarshalText(text []byte) error {
	if text == nil || len(text) == 0 {
		e.Valid = false
		return nil
	}

	e.Val = TaxCalculationStrategy(text)
	e.Valid = true
	return nil
}

// SetValid changes this NullTaxCalculationStrategy value and also sets it to be non-null.
func (e *NullTaxCalculationStrategy) SetValid(v TaxCalculationStrategy) {
	e.Val = v
	e.Valid = true
}

// Ptr returns a pointer to this NullTaxCalculationStrategy value, or a nil pointer if this NullTaxCalculationStrategy is null.
func (e NullTaxCalculationStrategy) Ptr() *TaxCalculationStrategy {
	if !e.Valid {
		return nil
	}
	return &e.Val
...
// IsZero returns true for null types.
func (e NullTaxCalculationStrategy) IsZero() bool {
	return !e.Valid
}

// Scan implements the Scanner interface.
func (e *NullTaxCalculationStrategy) Scan(value interface{}) error {
	if value == nil {
		e.Val, e.Valid = "", false
		return nil
	}
...
// Value implements the driver Valuer interface.
func (e NullTaxCalculationStrategy) Value() (driver.Value, error) {
	if !e.Valid {
		return nil, nil
	}
	return string(e.Val), nil
...
// Enum values for TransactionEventType
const (
	TransactionEventTypeAuthorizationSuccess        TransactionEventType = "authorization_success"
	TransactionEventTypeAuthorizationFailure        TransactionEventType = "authorization_failure"
	TransactionEventTypeAuthorizationAdjustment     TransactionEventType = "authorization_adjustment"
	TransactionEventTypeAuthorizationRequest        TransactionEventType = "authorization_request"
	TransactionEventTypeAuthorizationActionRequired TransactionEventType = "authorization_action_required"
	TransactionEventTypeChargeSuccess               TransactionEventType = "charge_success"
	TransactionEventTypeChargeFailure               TransactionEventType = "charge_failure"
	TransactionEventTypeChargeBack                  TransactionEventType = "charge_back"
	TransactionEventTypeChargeActionRequired        TransactionEventType = "charge_action_required"
	TransactionEventTypeChargeRequest               TransactionEventType = "charge_request"
	TransactionEventTypeRefundSuccess               TransactionEventType = "refund_success"
	TransactionEventTypeRefundFailure               TransactionEventType = "refund_failure"
	TransactionEventTypeRefundReverse               TransactionEventType = "refund_reverse"
	TransactionEventTypeRefundRequest               TransactionEventType = "refund_request"
	TransactionEventTypeCancelSuccess               TransactionEventType = "cancel_success"
	TransactionEventTypeCancelFailure               TransactionEventType = "cancel_failure"
	TransactionEventTypeCancelRequest               TransactionEventType = "cancel_request"
	TransactionEventTypeInfo                        TransactionEventType = "info"
)

func AllTransactionEventType() []TransactionEventType {
	return []TransactionEventType{
		TransactionEventTypeAuthorizationSuccess,
		TransactionEventTypeAuthorizationFailure,
		TransactionEventTypeAuthorizationAdjustment,
		TransactionEventTypeAuthorizationRequest,
		TransactionEventTypeAuthorizationActionRequired,
		TransactionEventTypeChargeSuccess,
		TransactionEventTypeChargeFailure,
		TransactionEventTypeChargeBack,
		TransactionEventTypeChargeActionRequired,
		TransactionEventTypeChargeRequest,
		TransactionEventTypeRefundSuccess,
		TransactionEventTypeRefundFailure,
		TransactionEventTypeRefundReverse,
		TransactionEventTypeRefundRequest,
		TransactionEventTypeCancelSuccess,
		TransactionEventTypeCancelFailure,
		TransactionEventTypeCancelRequest,
		TransactionEventTypeInfo,
	}
}

func (e TransactionEventType) IsValid() error {
	switch e {
	case TransactionEventTypeAuthorizationSuccess, TransactionEventTypeAuthorizationFailure, TransactionEventTypeAuthorizationAdjustment, TransactionEventTypeAuthorizationRequest, TransactionEventTypeAuthorizationActionRequired, TransactionEventTypeChargeSuccess, TransactionEventTypeChargeFailure, TransactionEventTypeChargeBack, TransactionEventTypeChargeActionRequired, TransactionEventTypeChargeRequest, TransactionEventTypeRefundSuccess, TransactionEventTypeRefundFailure, TransactionEventTypeRefundReverse, TransactionEventTypeRefundRequest, TransactionEventTypeCancelSuccess, TransactionEventTypeCancelFailure, TransactionEventTypeCancelRequest, TransactionEventTypeInfo:
		return nil
	default:
		return errors.New("enum is not valid")
	}
...
func (e TransactionEventType) String() string {
	return string(e)
}

func (e TransactionEventType) Ordinal() int {
	switch e {
	case TransactionEventTypeAuthorizationSuccess:
		return 0
	case TransactionEventTypeAuthorizationFailure:
		return 1
	case TransactionEventTypeAuthorizationAdjustment:
		return 2
	case TransactionEventTypeAuthorizationRequest:
		return 3
	case TransactionEventTypeAuthorizationActionRequired:
		return 4
	case TransactionEventTypeChargeSuccess:
		return 5
	case TransactionEventTypeChargeFailure:
		return 6
	case TransactionEventTypeChargeBack:
		return 7
	case TransactionEventTypeChargeActionRequired:
		return 8
	case TransactionEventTypeChargeRequest:
		return 9
	case TransactionEventTypeRefundSuccess:
		return 10
	case TransactionEventTypeRefundFailure:
		return 11
	case TransactionEventTypeRefundReverse:
		return 12
	case TransactionEventTypeRefundRequest:
		return 13
	case TransactionEventTypeCancelSuccess:
		return 14
	case TransactionEventTypeCancelFailure:
		return 15
	case TransactionEventTypeCancelRequest:
		return 16
	case TransactionEventTypeInfo:
		return 17
