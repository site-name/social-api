...
type ProductChannelListing struct {
	...
	AvailableForPurchaseAt model_types.NullInt64   `boil:"available_for_purchase_at" json:"available_for_purchase_at,omitempty" toml:"available_for_purchase_at" yaml:"available_for_purchase_at,omitempty"`
	...
	DiscountedPriceDirty   bool                    `boil:"discounted_price_dirty" json:"discounted_price_dirty" toml:"discounted_price_dirty" yaml:"discounted_price_dirty"`
...
var ProductChannelListingColumns = struct {
	...
	DiscountedPriceDirty:   "discounted_price_dirty",
}
...
var ProductChannelListingTableColumns = struct {
	...
	AvailableForPurchaseAt: "product_channel_listings.available_for_purchase_at",
	...
	DiscountedPriceDirty:   "product_channel_listings.discounted_price_dirty",
}
...
var ProductChannelListingWhere = struct {
	...
	AvailableForPurchaseAt whereHelpermodel_types_NullInt64
	...
	DiscountedPriceDirty   whereHelperbool
}{
	...
	AvailableForPurchaseAt: whereHelpermodel_types_NullInt64{field: "\"product_channel_listings\".\"available_for_purchase_at\""},
	...
	DiscountedPriceDirty:   whereHelperbool{field: "\"product_channel_listings\".\"discounted_price_dirty\""},
}
...
var (
	productChannelListingAllColumns            = []string{"id", "product_id", "channel_id", "visible_in_listings", "available_for_purchase_at", "currency", "discounted_price_amount", "created_at", "publication_date", "is_published", "discounted_price_dirty"}
	productChannelListingColumnsWithoutDefault = []string{"id", "product_id", "channel_id", "visible_in_listings", "currency", "created_at", "is_published", "discounted_price_dirty"}
	productChannelListingColumnsWithDefault    = []string{"available_for_purchase_at", "discounted_price_amount", "publication_date"}
...
func (o *ProductChannelListing) SetChannel(exec boil.Executor, insert bool, related *Channel) error {
	var err error
	if insert {
...
// Adds o to related.R.ProductChannelListings.
func (o *ProductChannelListing) SetProduct(exec boil.Executor, insert bool, related *Product) error {
	var err error
	if insert {
		if err = related.Insert(exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func (o ProductChannelListingSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"product_channel_listings\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, productChannelListingPrimaryKeyColumns, len(o))
