...
type CustomerNote struct {
	...
	UserID     *UUID  `json:"user_id" gorm:"type:uuid;index:customernotes_userid_key;column:UserID"`
	...
	CustomerID UUID   `json:"customer_id" gorm:"type:uuid;index:customernotes_customerid_key;column:CustomerID"`
}
