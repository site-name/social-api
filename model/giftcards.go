...
type Giftcard struct {
	...
	FulfillmentLineID    model_types.NullString  `boil:"fulfillment_line_id" json:"fulfillment_line_id,omitempty" toml:"fulfillment_line_id" yaml:"fulfillment_line_id,omitempty"`
	...
	SearchIndexDirty     model_types.NullBool    `boil:"search_index_dirty" json:"search_index_dirty,omitempty" toml:"search_index_dirty" yaml:"search_index_dirty,omitempty"`
...
var GiftcardColumns = struct {
	...
	SearchIndexDirty:     "search_index_dirty",
...
var GiftcardTableColumns = struct {
	...
	AppID:                "giftcards.app_id",
	FulfillmentLineID:    "giftcards.fulfillment_line_id",
	SearchVector:         "giftcards.search_vector",
	SearchIndexDirty:     "giftcards.search_index_dirty",
...
var GiftcardWhere = struct {
	...
	FulfillmentLineID    whereHelpermodel_types_NullString
	SearchVector         whereHelpermodel_types_NullString
	SearchIndexDirty     whereHelpermodel_types_NullBool
	...
	AppID:                whereHelpermodel_types_NullString{field: "\"giftcards\".\"app_id\""},
	FulfillmentLineID:    whereHelpermodel_types_NullString{field: "\"giftcards\".\"fulfillment_line_id\""},
	SearchVector:         whereHelpermodel_types_NullString{field: "\"giftcards\".\"search_vector\""},
	SearchIndexDirty:     whereHelpermodel_types_NullBool{field: "\"giftcards\".\"search_index_dirty\""},
...
var GiftcardRels = struct {
	...
	GiftcardTagGiftcards: "GiftcardTagGiftcards",
	OrderGiftcards:       "OrderGiftcards",
}

// giftcardR is where relationships are stored.
type giftcardR struct {
	FulfillmentLine      *FulfillmentLine         `boil:"FulfillmentLine" json:"FulfillmentLine" toml:"FulfillmentLine" yaml:"FulfillmentLine"`
	...
	GiftcardTagGiftcards GiftcardTagGiftcardSlice `boil:"GiftcardTagGiftcards" json:"GiftcardTagGiftcards" toml:"GiftcardTagGiftcards" yaml:"GiftcardTagGiftcards"`
...
func (r *giftcardR) GetFulfillmentLine() *FulfillmentLine {
	if r == nil {
		return nil
	}
	return r.FulfillmentLine
}
...
func (r *giftcardR) GetGiftcardTagGiftcards() GiftcardTagGiftcardSlice {
	if r == nil {
		return nil
	}
	return r.GiftcardTagGiftcards
}
...
var (
	giftcardAllColumns            = []string{"id", "code", "created_by_id", "used_by_id", "created_by_email", "used_by_email", "created_at", "expiry_date", "tag", "product_id", "last_used_on", "is_active", "currency", "initial_balance_amount", "current_balance_amount", "app_id", "fulfillment_line_id", "search_vector", "search_index_dirty", "annotations", "metadata", "private_metadata"}
	giftcardColumnsWithoutDefault = []string{"id", "code", "created_at", "currency"}
	giftcardColumnsWithDefault    = []string{"created_by_id", "used_by_id", "created_by_email", "used_by_email", "expiry_date", "tag", "product_id", "last_used_on", "is_active", "initial_balance_amount", "current_balance_amount", "app_id", "fulfillment_line_id", "search_vector", "search_index_dirty", "annotations", "metadata", "private_metadata"}
...
// FulfillmentLine pointed to by the foreign key.
func (o *Giftcard) FulfillmentLine(mods ...qm.QueryMod) fulfillmentLineQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id\" = ?", o.FulfillmentLineID),
	}
...
// GiftcardTagGiftcards retrieves all the giftcard_tag_giftcard's GiftcardTagGiftcards with an executor.
func (o *Giftcard) GiftcardTagGiftcards(mods ...qm.QueryMod) giftcardTagGiftcardQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"giftcard_tag_giftcards\".\"giftcard_id\"=?", o.ID),
	)
...
// LoadFulfillmentLine allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (giftcardL) LoadFulfillmentLine(e boil.Executor, singular bool, maybeGiftcard interface{}, mods queries.Applicator) error {
	var slice []*Giftcard
	var object *Giftcard
	...
	if singular {
		...
		if !queries.IsNil(object.FulfillmentLineID) {
			args[object.FulfillmentLineID] = struct{}{}
		}
		...
		for _, obj := range slice {
			...
			if !queries.IsNil(obj.FulfillmentLineID) {
				args[obj.FulfillmentLineID] = struct{}{}
			}
	...
	query := NewQuery(
		...
		qm.WhereIn(`fulfillment_lines.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load FulfillmentLine")
	}

	var resultSlice []*FulfillmentLine
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice FulfillmentLine")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for fulfillment_lines")
	}
	...
	if singular {
		...
		object.R.FulfillmentLine = foreign
		if foreign.R == nil {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.FulfillmentLineID, foreign.ID) {
				local.R.FulfillmentLine = foreign
				if foreign.R == nil {
					foreign.R = &fulfillmentLineR{}
				}
...
// LoadGiftcardTagGiftcards allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (giftcardL) LoadGiftcardTagGiftcards(e boil.Executor, singular bool, maybeGiftcard interface{}, mods queries.Applicator) error {
	var slice []*Giftcard
	var object *Giftcard
	...
	query := NewQuery(
		...
		qm.WhereIn(`giftcard_tag_giftcards.giftcard_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.GiftcardTagGiftcards = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.GiftcardID {
				local.R.GiftcardTagGiftcards = append(local.R.GiftcardTagGiftcards, foreign)
				if foreign.R == nil {
					foreign.R = &giftcardTagGiftcardR{}
				}
				foreign.R.Giftcard = local
...
// SetFulfillmentLine of the giftcard to the related item.
// Sets o.R.FulfillmentLine to related.
// Adds o to related.R.Giftcards.
func (o *Giftcard) SetFulfillmentLine(exec boil.Executor, insert bool, related *FulfillmentLine) error {
	var err error
	if insert {
	...
	updateQuery := fmt.Sprintf(
		...
		strmangle.SetParamNames("\"", "\"", 1, []string{"fulfillment_line_id"}),
	...
	queries.Assign(&o.FulfillmentLineID, related.ID)
	if o.R == nil {
		o.R = &giftcardR{
			FulfillmentLine: related,
		}
	} else {
		o.R.FulfillmentLine = related
	}

	if related.R == nil {
		related.R = &fulfillmentLineR{
...
// RemoveFulfillmentLine relationship.
// Sets o.R.FulfillmentLine to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Giftcard) RemoveFulfillmentLine(exec boil.Executor, related *FulfillmentLine) error {
	var err error

	queries.SetScanner(&o.FulfillmentLineID, nil)
	if _, err = o.Update(exec, boil.Whitelist("fulfillment_line_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.FulfillmentLine = nil
	}
	...
	for i, ri := range related.R.Giftcards {
		if queries.Equal(o.FulfillmentLineID, ri.FulfillmentLineID) {
			continue
		}
...
// AddGiftcardTagGiftcards adds the given related objects to the existing relationships
// of the giftcard, optionally inserting them as new records.
// Appends related to o.R.GiftcardTagGiftcards.
// Sets related.R.Giftcard appropriately.
func (o *Giftcard) AddGiftcardTagGiftcards(exec boil.Executor, insert bool, related ...*GiftcardTagGiftcard) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.GiftcardID = o.ID
	...
	if o.R == nil {
		o.R = &giftcardR{
			GiftcardTagGiftcards: related,
		}
	} else {
		o.R.GiftcardTagGiftcards = append(o.R.GiftcardTagGiftcards, related...)
	}
...
func (o GiftcardSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"giftcards\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, giftcardPrimaryKeyColumns, len(o))
