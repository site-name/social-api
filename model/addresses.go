...
type Address struct {
	...
	ValidationSkipped bool        `boil:"validation_skipped" json:"validation_skipped" toml:"validation_skipped" yaml:"validation_skipped"`
...
var AddressTableColumns = struct {
	...
	ValidationSkipped: "addresses.validation_skipped",
}
...
var AddressWhere = struct {
	...
	ValidationSkipped whereHelperbool
}{
	...
	ValidationSkipped: whereHelperbool{field: "\"addresses\".\"validation_skipped\""},
}
...
var (
	addressAllColumns            = []string{"id", "first_name", "last_name", "company_name", "street_address1", "street_address2", "city", "city_area", "postal_code", "country", "country_area", "phone", "user_id", "created_at", "updated_at", "validation_skipped"}
	...
	addressColumnsWithDefault    = []string{"validation_skipped"}
...
func (o AddressSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"addresses\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, addressPrimaryKeyColumns, len(o))
